...
const SCENARIOS = {
  pitcher: [
    {id:"p1",title:"Full Count Pressure",diff:3,cat:"pressure",conceptTag:"count-leverage",
    ...
    {id:"p2",title:"First Batter of the Game",diff:1,cat:"counts",conceptTag:"first-pitch-strike",
    ...
    {id:"p3",title:"Runner Threatening to Steal",diff:2,cat:"baserunners",conceptTag:"steal-breakeven",
    ...
    {id:"p5",title:"Setting Up the Strikeout",diff:2,cat:"counts",conceptTag:"two-strike-approach",
    ...
    {id:"p6",title:"Double Play Groundball",diff:2,cat:"situational",conceptTag:"double-play-turn",
    ...
    {id:"p28",title:"First and Third Groundball",diff:2,cat:"baserunners",conceptTag:"first-third",
    ...
    {id:"p54",title:"Lefty-Righty Walk Advantage",diff:2,cat:"strategy",conceptTag:"force-vs-tag",
    ...
    {id:"p59",title:"Cover First on the Wild Strikeout",diff:2,cat:"pitcher",
      description:"You're the pitcher. Your curveball bounces in the dirt for strike three! The catcher dives left, but the ball rolls toward the first base dugout. Bases are empty with no outs and a 1-run lead in the top of the 7th. The batter takes off running toward first.",
      situation:{inning:"Top 7",outs:0,count:"0-2",runners:[],score:[2,1]},
  ...
  batter: [
    ...
    {id:"b3",title:"Hit and Run",diff:1,cat:"plays",conceptTag:"hit-and-run",
    ...
    {id:"b33",title:"0-2 Same Pitch Twice",diff:3,cat:"counts",conceptTag:"two-strike-approach",
    ...
    {id:"b35",title:"Bunt Him to Third",diff:1,cat:"plays",conceptTag:"bunt-re24",
    ...
    {id:"b42",title:"Two Strikes — Change Your Swing",diff:1,cat:"counts",conceptTag:"two-strike-approach",
    ...
    {id:"b44",title:"Two Strikes — Breaking Ball Barrage",diff:2,cat:"counts",conceptTag:"two-strike-approach",
  ...
  secondBase: [
    ...
    {id:"f12",title:"Relay Position",diff:2,cat:"outfield",conceptTag:"relay-double-cut",
    ...
    {id:"f14",title:"Bases Empty — Routine Grounder",diff:1,cat:"infield",conceptTag:"force-vs-tag",
    ...
    {id:"2b3",title:"Covering First on the Bunt",diff:1,cat:"fielder",conceptTag:"bunt-defense",
    ...
    {id:"2b9",title:"Slow Roller Up the Middle",diff:1,cat:"fielder",
      description:"You're the second baseman. Nobody on base, two outs, and the batter chops a slow ground ball up the middle toward second base. The ball is trickling through the grass and losing speed fast. You charge in to field it. What's your play?",
      situation:{inning:"Top 5",outs:2,count:"1-2",runners:[],score:[2,1]},
      options:["Charge hard, field the ball out in front of you, and make a strong throw to first while your momentum carries you forward","Wait at your position and let the ball roll to you, then throw to first","Field the ball and run it toward first base before throwing","Charge in, pick it up with your bare hand, and flip underhand to the pitcher covering first"],
      best:0,explanations:["Great play! On a slow roller, you have to attack the ball \u2014 don't let it play you. Charging forward gives you two advantages: you get to the ball faster while it still has some hop to it, and your forward momentum adds power to your throw. Field it out in front, transfer quickly, and fire to first.","Waiting for a slow roller to come to you is a recipe for an infield single. The ball is dying in the grass, and every second you wait, the batter gets closer to first. You have to charge aggressively to have any chance at the out.","Running the ball toward first wastes precious time. Your arm is faster than your legs! Field it and throw \u2014 that's always quicker than trying to hand-deliver the ball. The batter will beat you in a foot race.","A bare-hand flip to the pitcher covering first sounds fancy, but it's risky and unnecessary here. The ball is up the middle, not on the first base line. You have time to field it in your glove and make a normal throw. Save the bare hand for the really tough slow rollers close to the line."],
      rates:[85,15,30,40],concept:"On a slow roller, charge the ball aggressively \u2014 your forward momentum helps you field it cleanly and adds power to your throw to first.",anim:"groundout"},
    {id:"2b10",title:"Double Play Feed From the Pitcher",diff:2,cat:"fielder",
      description:"You're the second baseman. Runner on first, nobody out. The batter hits a come-backer to the pitcher, who fields it and turns to throw to you at second base to start the double play. The throw is coming \u2014 how do you handle the feed and make the turn?",
      situation:{inning:"Bot 3",outs:0,count:"0-1",runners:[1],score:[1,1]},
      options:["Catch the ball at the bag, touch second with your left foot, and use the pitcher's throw momentum to redirect a quick sidearm throw to first","Catch it, step on the bag with your right foot, then crow-hop and make a full overhand throw to first","Catch it and hold the ball \u2014 the force out at second is enough with nobody out","Catch it, but jump high in the air to avoid the sliding runner before throwing"],
      best:0,explanations:["Textbook pivot on a feed from the pitcher! You catch the ball, touch the bag with your left foot as you step across the base, and redirect a quick sidearm throw to first. Using the momentum of the incoming throw helps you get the ball to first faster. Smooth footwork turns two!","Stepping on the bag with your right foot puts you on the wrong side of the base and forces a longer, slower throwing motion. By the time you crow-hop and throw overhand, the batter has reached first. The left foot touch and quick sidearm is much faster.","Just taking the force out at second wastes a golden double play opportunity. With nobody out, getting two outs on one play changes the whole inning. Always try to complete the double play when you can.","Jumping high makes your throw inaccurate and costs you time in the air. A small step across the bag to the infield side is all you need to clear the runner. Stay low, stay quick, and get the ball to first."],
      rates:[85,35,20,25],concept:"On a double play feed from the pitcher, touch second with your left foot and redirect a quick sidearm throw to first \u2014 footwork and momentum are the keys.",anim:"doubleplay"},
    {id:"2b11",title:"Bunt Play \u2014 Cover First!",diff:2,cat:"fielder",conceptTag:"bunt-defense",
      description:"You're the second baseman. Runner on first, no outs, and the batter squares to bunt. The first baseman charges hard toward home plate, the pitcher is breaking toward the third base line, and the third baseman is charging too. The bunt is down \u2014 a decent one rolling toward the pitcher. Where do you need to be?",
      situation:{inning:"Top 6",outs:0,count:"1-0",runners:[1],score:[3,2]},
      options:["Sprint to cover first base \u2014 the first baseman left it empty when he charged the bunt","Run toward second base to cover the bag in case of a throw there","Stay in your normal position and watch the play develop","Move toward the mound area to back up the pitcher's throw"],
      best:0,explanations:["You nailed it! When the first baseman charges a bunt, first base is wide open and someone MUST cover it. That's YOUR job as the second baseman. Sprint to the bag, get there before the throw, and give the fielder a clear target. If nobody covers first, the batter gets a free base even on a great defensive play.","The shortstop covers second base on a bunt play, not you. Your responsibility is first base. If both middle infielders go to second, nobody is at first and the defense falls apart \u2014 the fielder has nobody to throw to.","Standing and watching is never the answer on a bunt play. Every fielder has a job, and yours is to cover first base the instant you see the bunt go down. If you hesitate even a second, you won't get there in time.","Backing up the throw sounds helpful but leaves first base uncovered. The catcher is the one who backs up throws in the infield. Your job is to get to that first base bag \u2014 there's nobody else who can do it."],
      rates:[85,25,10,20],concept:"On a sacrifice bunt, the second baseman must sprint to cover first base when the first baseman charges \u2014 every fielder has a specific bunt responsibility.",anim:"bunt"},
    {id:"2b12",title:"Pop Fly \u2014 You or the Right Fielder?",diff:1,cat:"fielder",
      description:"You're the second baseman. Runner on third, one out, close game. The batter pops the ball up into shallow right field. You're drifting back for it and the right fielder is charging in hard. The ball is hanging up there \u2014 who should catch it?",
      situation:{inning:"Bot 6",outs:1,count:"1-1",runners:[3],score:[4,5]},
      options:["Let the right fielder take it \u2014 he's coming in and can see the ball better","Call for it loudly and catch it yourself since you're closer","Let the first baseman take it since he's on that side of the field","Stay quiet and just get out of the way so nobody collides"],
      best:0,explanations:["Smart decision! The right fielder charging in has the ball in front of him the entire time \u2014 much easier to track and catch. Plus, with a runner on third and one out, the right fielder's forward momentum puts him in a great position to catch and throw home if the runner tags up. Two great reasons to let the outfielder have it.","You're drifting back, which means the ball is moving away from you \u2014 that's one of the hardest catches in baseball. The right fielder running in can see the ball clearly in front of him the whole way. Outfielders coming in always have priority over infielders going back.","The first baseman would have to range far from his position and he'd be going back on the ball too. This is between you and the right fielder, and the right fielder has the better angle every time.","Never stay quiet on a fly ball! Someone MUST call for it or you risk a collision and a dropped ball. Communication saves games \u2014 and prevents injuries. The right fielder should call for it, and you should peel off."],
      rates:[85,40,15,10],concept:"Outfielders charging in always have priority over infielders going back \u2014 the ball is easier to catch running forward, and with a runner on third, the outfielder has better throwing momentum toward home.",anim:"catch"},
    {id:"2b13",title:"Tag at Second on the Steal",diff:2,cat:"fielder",
      description:"You're the second baseman and you're covering second base on a steal attempt. Runner on first takes off, and the catcher guns a throw to you. The throw is a little to the first base side of the bag. The runner is sliding in hard from the right. How do you apply the tag?",
      situation:{inning:"Top 4",outs:1,count:"0-2",runners:[1],score:[1,0]},
      options:["Catch the ball, bring your glove down quickly in front of the bag on the runner's path, and let him slide into the tag","Catch the ball and then chase the tag toward the runner's body","Catch it, but hold the tag up high waiting for the runner to pop up","Move your whole body in front of the runner to block the bag, then tag him"],
      best:0,explanations:["Perfect tag technique! Catch the throw, then sweep your glove down right in front of the base where the runner's feet are heading. You don't chase the runner \u2014 you put the tag in his path and let him slide into it. Quick hands and good positioning make this an easy out.","Chasing the tag toward the runner means extra movement and wasted time. The runner is already coming to you at full speed \u2014 just put the glove in his path. Let his momentum do the work. Chasing the tag also risks the ball getting knocked loose.","Holding the tag up high while the runner slides in low means you miss the tag entirely. The runner's feet or hands arrive at the base first, so that's where the tag needs to be \u2014 down low, right in front of the bag.","Blocking the bag without the ball is obstruction, and even with the ball, putting your whole body in the runner's path is dangerous. You could get hurt badly on a hard slide. Straddle the bag, stay to the side, and apply a quick sweep tag \u2014 safe and effective."],
      rates:[85,30,20,15],concept:"On a steal tag, catch the throw and sweep the glove down in front of the base \u2014 let the runner slide into your tag instead of chasing him.",anim:"steal"},
    {id:"2b14",title:"Positioning vs. a Lefty Pull Hitter",diff:3,cat:"fielder",
      description:"You're the second baseman. Runner on first, one out, and a powerful left-handed pull hitter is at the plate. Your coach calls for a defensive shift. Left-handed pull hitters crush the ball to the right side of the field. Where should you position yourself, and what are you thinking about?",
      situation:{inning:"Top 7",outs:1,count:"0-0",runners:[1],score:[5,4]},
      options:["Shade several steps toward first base into the hole between first and second \u2014 that's where a lefty pull hitter is most likely to hit ground balls, while still being ready to cover second on a steal or double play","Move to your normal position \u2014 shifts are only for the pros","Shade toward second base to be ready for the double play since there's a runner on first","Move all the way to the left side of the infield with the shortstop and third baseman"],
      best:0,explanations:["Excellent positioning! Left-handed pull hitters tend to drive the ball toward the right side of the field. By shading several steps toward the first base hole, you're putting yourself where the ball is most likely to go. But you're also smart enough to stay close enough to second that you can still get there for a steal or double play. It's about playing the percentages while staying responsible.","Shifts aren't just for the pros \u2014 they work at every level! If you know a batter tends to hit to one side, moving a few steps in that direction gives you a much better chance of making the play. Good defense is about being in the right spot BEFORE the pitch.","Moving toward second base takes you away from where this hitter is most likely to hit the ball. Yes, there's a runner on first, but you can still turn a double play from a shifted position \u2014 you just take a slightly different angle to the bag. Don't sacrifice your best positioning just for the DP.","Moving all the way to the left side is way too extreme. That leaves the entire right side of the infield completely empty \u2014 the batter could just bunt or poke a ball the other way for an easy hit. A shift means adjusting a few steps, not abandoning your side of the field entirely."],
      rates:[82,20,35,15],concept:"Against left-handed pull hitters, shade toward first base where they're most likely to hit \u2014 play the percentages but stay close enough to second for steal and double play coverage.",anim:"groundout"},
  ],
  shortstop: [
    ...
    {id:"ss3",title:"Covering on the Steal",diff:2,cat:"fielder",conceptTag:"steal-breakeven",
    ...
    {id:"ss5",title:"Relay Man to Left-Center",diff:1,cat:"fielder",conceptTag:"relay-double-cut",
    ...
    {id:"ss9",title:"Ranging Deep in the Hole",diff:2,cat:"fielder",
      description:"You're the shortstop. Runner on first, two outs. The batter hits a hard ground ball deep in the hole between short and third. You range far to your right, backhand the ball cleanly, and now you're almost behind third base. The runner on first is moving. What's your best play?",
      situation:{inning:"Bot 5",outs:2,count:"2-1",runners:[1],score:[3,2]},
      options:["Plant your back foot hard, set up, and fire a strong overhand throw across the diamond to first base","Flip the ball to the third baseman and let him make the throw to first","Lob a high, arching throw to first to make sure it gets there","Spin toward second base and try to get the force out on the lead runner"],
      best:0,explanations:["This is the shortstop's money play! After ranging deep into the hole and backhanding the ball, you plant your back foot hard to stop your momentum, get your feet set, and fire across the diamond. It takes a strong arm and great footwork \u2014 you're throwing from far away, so you need everything behind it. This is the play that separates great shortstops from good ones.","The third baseman isn't positioned to receive your flip \u2014 he's not expecting it and may not even be near third base. By the time he catches your flip, adjusts, and throws, the runner is safe at first. You have to make this throw yourself.","A lob from deep in the hole will never beat the runner. You're already far from first, and a slow, arching throw gives the batter extra time. You need a hard, low throw \u2014 a line drive to the first baseman's glove. Lobs are for Sunday catch, not game situations.","Spinning toward second takes time and the throw to second is awkward from this angle. With two outs, you don't need the force at second \u2014 just get the batter at first. One out ends the inning. Keep it simple."],
      rates:[85,20,15,25],concept:"On a deep backhand in the hole, plant hard and fire across the diamond \u2014 your arm strength and footwork are what make this signature shortstop play possible.",anim:"groundout"},
    {id:"ss10",title:"Relay on a Left-Center Gap Shot",diff:2,cat:"fielder",
      description:"You're the shortstop. Runner on first, nobody out, and the batter rips a ball into the left-center field gap. It rolls all the way to the warning track. The runner from first is rounding second and heading for third \u2014 he might try to score. You need to get out as the relay man. How do you set up?",
      situation:{inning:"Top 7",outs:0,count:"1-0",runners:[1],score:[2,3]},
      options:["Sprint out and line up between the outfielder and home plate, hands raised high so the outfielder can see you \u2014 listen to your teammates for where to throw","Line up between the outfielder and third base since that's where the lead runner is heading","Stay at shortstop position and let the outfielder make the throw himself","Sprint all the way to the outfielder to shorten his throw as much as possible"],
      best:0,explanations:["Perfect relay setup! On balls to left-center, the shortstop is the relay man. Your default alignment is always toward home plate because preventing runs is the #1 priority. Put your hands up high so the outfielder has a clear target. Your teammates behind you will yell directions \u2014 if they say 'cut three!' you cut it and throw to third. If they say 'let it go!' the throw is on line to home. Trust your ears.","Lining up toward third can work if the runner clearly stops, but your default should always be home plate. If you line up to third and the runner keeps going, you've already lost. Start with home as your target \u2014 you can always redirect to third after you catch the ball.","The outfielder cannot make a 250-foot throw to home plate on the fly \u2014 that's nearly impossible. The relay man exists to break that long throw into two shorter, faster throws. Without you out there, the runner scores easily.","Going too far toward the outfielder defeats the purpose of a relay. You want to position yourself so you can catch the outfielder's throw and make a strong relay throw home. If you're too deep in the outfield, your throw home is still really long. Find the sweet spot \u2014 roughly in line with the edge of the outfield grass."],
      rates:[85,45,10,20],concept:"On relay plays to left-center, the shortstop lines up between the outfielder and home plate \u2014 preventing runs is always the default priority. Hands up, ears open.",anim:"throwHome"},
    {id:"ss11",title:"Steal Coverage With a Righty Batting",diff:1,cat:"fielder",
      description:"You're the shortstop. Runner on first with speed, and a right-handed batter is at the plate. The runner takes off for second on the pitch. The catcher fires the throw. On this play, who covers second base \u2014 you or the second baseman?",
      situation:{inning:"Top 2",outs:0,count:"1-1",runners:[1],score:[0,0]},
      options:["You cover second base \u2014 with a right-handed batter up, the ball is more likely hit to the left side, so the second baseman stays in his fielding position","The second baseman covers \u2014 he's closer to the bag","Both of you run to the bag so someone is definitely there","Neither of you \u2014 the pitcher covers second on a steal"],
      best:0,explanations:["Exactly right! With a right-handed batter, the ball is more likely to be pulled to the left side of the field. That means the second baseman needs to stay in his position to field a possible ground ball hit to the right side. So the shortstop covers second on the steal. It's all about protecting the side of the field where the ball is most likely NOT to go.","The second baseman might be physically closer, but with a right-handed batter up, he needs to stay in his fielding position. If he breaks toward second to cover the steal and the batter hits a ground ball to the right side, there's nobody there. The coverage depends on the batter, not the distance.","If both of you run to the bag, you leave the entire middle of the infield wide open. What if the batter swings and hits a ground ball? It rolls through for an easy hit because nobody is in position. Only one middle infielder covers \u2014 the other stays home.","The pitcher has to deliver the pitch and then be ready to field a batted ball. He can't cover second base on a steal \u2014 that's the middle infielders' job. The shortstop and second baseman divide this responsibility based on the handedness of the batter."],
      rates:[85,35,10,15],concept:"With a right-handed batter, the shortstop covers second on a steal because the second baseman needs to protect the right side where a righty is more likely to hit.",anim:"steal"},
    {id:"ss12",title:"Double Play Depth or Normal Depth?",diff:2,cat:"fielder",conceptTag:"dp-positioning",
      description:"You're the shortstop. It's a tie game in the 6th inning. Runner on first, nobody out. Your coach tells you to get into double play depth. What does that mean, and why does it matter?",
      situation:{inning:"Top 6",outs:0,count:"0-0",runners:[1],score:[3,3]},
      options:["Move a few steps toward second base and a step or two closer to home plate \u2014 shorter distance to second base means you can start the double play faster","Move several steps toward third to increase your range in the hole","Stay at your normal depth but move closer to second base only","Move way in on the grass, almost behind the pitcher's mound"],
      best:0,explanations:["That's double play depth! You move a couple of steps toward second base (shorter throw or quicker feed to start the DP) and a step or two in toward home (so the ball gets to you faster and you have more time to turn two). You sacrifice a little range deep in the hole, but the double play is worth it \u2014 two outs changes the whole inning.","Moving toward third gives you more range in the hole, but it makes the double play much harder. You're farther from second base, so the feed takes longer. With a runner on first and nobody out, the double play is your priority \u2014 position for it.","Moving laterally toward second without coming in a step means the ball takes longer to reach you. Coming in slightly means you get the ball a fraction of a second sooner, and on a double play, every fraction counts. Both adjustments matter.","Moving way in on the grass is too aggressive. You'd be so close to home that hard ground balls get through before you can react. Double play depth is a subtle adjustment \u2014 a few steps, not a radical change. You still need to be able to field normal ground balls."],
      rates:[85,20,35,15],concept:"Double play depth means a few steps toward second base and a step in toward home \u2014 shorter distance to the bag and quicker reactions make turning two possible.",anim:"doubleplay"},
    {id:"ss13",title:"Pop Fly in Shallow Left",diff:1,cat:"fielder",
      description:"You're the shortstop. Runners on first and third, one out. The batter pops the ball up into shallow left field. You're going back on the ball and the left fielder is charging in. The third baseman has pulled off to cover his base. Who should catch this?",
      situation:{inning:"Bot 5",outs:1,count:"0-2",runners:[1,3],score:[2,3]},
      options:["Let the left fielder take it \u2014 he's charging in and can see the ball in front of him the whole way","Call for it yourself \u2014 you're the shortstop and you're closer","Let the third baseman come over since it's on the left side","Nobody calls for it \u2014 just see who gets there first"],
      best:0,explanations:["Smart play! The left fielder charging in has the ball in front of him the entire way \u2014 that's a much easier catch than you going back over your shoulder. Outfielders coming in always have priority over infielders going back. Plus, with a runner on third, the left fielder's forward momentum gives him a better position to throw home if the runner tags up. Let the outfielder have it!","Going back on a fly ball is the hardest catch in baseball \u2014 the ball drifts away from you and you're running almost blind. The left fielder running forward can track the ball the whole way and make a much easier catch. Don't let pride get in the way of good defense.","The third baseman has to cover third base with a runner there. He can't leave the bag to chase a pop fly. This is between you and the left fielder, and the left fielder wins that priority battle every time.","Never leave a fly ball uncalled! When nobody communicates, players crash into each other or the ball drops. The left fielder should call for it loudly, and you should peel off. Communication prevents disasters."],
      rates:[85,30,10,15],concept:"Outfielders running in always have priority over infielders going back \u2014 the ball is easier to see and catch when it's in front of you, not over your shoulder.",anim:"catch"},
    {id:"ss14",title:"Throwing on the Run \u2014 Backhand Side",diff:3,cat:"fielder",
      description:"You're the shortstop in a one-run game. Runner on second, two outs. The batter hits a ground ball to your backhand side \u2014 not deep in the hole, but far enough that you have to range to your right and field it on the move. You don't have time to plant and set your feet. How do you make this throw?",
      situation:{inning:"Top 7",outs:2,count:"1-2",runners:[2],score:[4,3]},
      options:["Field it on the run, skip the plant, and throw sidearm to first using your momentum \u2014 your body is already going that direction so let it work for you","Stop completely, set your feet, then make a perfect overhand throw to first","Field it and flip underhand to the second baseman to relay to first","Hold the ball \u2014 with two outs and a runner on second, wait for a better play"],
      best:0,explanations:["Elite play! When you're ranging to your backhand side and don't have time to plant, you throw on the run with a sidearm or three-quarter arm slot. Your momentum is already carrying you toward the first base side of the field, so you use that energy in your throw. It's not as strong as a planted throw, but it's FAST \u2014 and fast is what you need when the runner is flying down the line. This is a big-league skill.","Stopping to set your feet is ideal in most situations, but here you don't have time. The ball was hit hard enough to your right that if you stop, plant, and throw overhand, the batter beats it out. Sometimes you have to sacrifice a little accuracy for speed. Trust your arm and let it fly on the move.","Flipping to the second baseman adds an extra exchange \u2014 your flip, his catch, his throw. Two throws take longer than one. And the second baseman may not even be in position to receive a flip. Make the throw yourself and get the inning-ending out.","Holding the ball with two outs means the inning continues and the runner on second stays in scoring position. You need this out to end the inning and protect your one-run lead. Every out matters \u2014 make the throw!"],
      rates:[82,30,15,10],concept:"When ranging to the backhand side without time to plant, throw sidearm on the run \u2014 use your momentum toward first base to power the throw instead of fighting it.",anim:"groundout"}
  ],
  centerField: [
    ...
    {id:"cf1",title:"Take Charge on the Pop Fly",diff:1,cat:"fielder",conceptTag:"fly-ball-priority",
    ...
    {id:"cf4",title:"Back Up the Play",diff:1,cat:"fielder",conceptTag:"backup-duties",
    ...
    {id:"cf9",title:"Line Drive Read",diff:1,cat:"fielder",
      description:"The batter swings hard and the ball jumps off the bat heading your way. It's coming fast and you need to decide instantly \u2014 is this a line drive that's going to sink or a fly ball that will carry?",
      situation:{inning:"Top 3",outs:1,count:"-",runners:[1],score:[2,1]},
      options:["Take a step back first, then adjust forward if needed","Charge in aggressively right away","Stay frozen and wait to see what happens","Turn and run straight back to the wall"],
      best:0,explanations:["Taking a drop step back first is the golden rule of outfield reads. It's much easier to come forward on a ball than to recover after charging in on a line drive that carries over your head. This protects against the worst outcome \u2014 a ball getting behind you for extra bases.","Charging in is tempting, but if this ball has any carry at all, it sails over your head and rolls to the wall. A single becomes a triple. Only charge when you're 100% sure it's a short fly.","Staying frozen wastes your most precious resource \u2014 reaction time. Every fraction of a second matters on a hard-hit ball. You need to move immediately, and your first step should be back.","Turning and sprinting to the wall only makes sense on an obvious deep fly. On a ball you're still reading, you'll lose sight of it completely and have no chance to adjust."],
      rates:[85,25,15,20],concept:"On a hard-hit ball, your first step should always be back \u2014 it's easier to come in than go back.",anim:"catch"},
    {id:"cf10",title:"Backing Up Second",diff:2,cat:"fielder",
      description:"Runner on first takes off stealing. The catcher fires a strong throw to second base. You're in center field about 150 feet behind the bag. The shortstop is covering the base.",
      situation:{inning:"Bot 4",outs:0,count:"1-1",runners:[1],score:[3,3]},
      options:["Sprint in behind second base in a direct line with the catcher's throw","Stay in your normal center field position and watch","Move toward second but angle toward the right field side","Drift slowly toward the bag, staying shallow"],
      best:0,explanations:["This is your job on every steal attempt. Sprint directly behind second base, lined up with the catcher's throw. If the ball gets past the shortstop or bounces away, you're right there to keep the runner from advancing to third. Great center fielders do this automatically.","Staying put is a missed responsibility. If the throw skips past the infielder, the runner jogs to third with nobody backing up. That turns a stolen base into a runner 90 feet from scoring.","Angling toward right field takes you off the line of the throw. A backup should always be directly behind the base in line with the throw \u2014 that way a missed ball comes right to you instead of past you at an angle.","Drifting slowly won't get you close enough. You need to sprint hard to get within 30-40 feet of the bag. A lazy backup is almost as bad as no backup at all."],
      rates:[88,15,30,35],concept:"Center fielders back up second base on every steal attempt and infield throw \u2014 sprint in directly behind the bag, in line with the throw.",anim:"steal"},
    {id:"cf11",title:"Ball Off the Wall",diff:2,cat:"fielder",
      description:"Deep fly ball to center field \u2014 you turn and chase it but it's going to reach the wall. The ball hits the padded wall about 8 feet high and bounces back. Runner on first is sprinting hard around second. You need to play this carom cleanly.",
      situation:{inning:"Top 6",outs:1,count:"-",runners:[1],score:[4,5]},
      options:["Set up a few feet off the wall and field the carom with two hands, then hit your cutoff man","Run to the wall, grab the ball, and throw it as hard as you can to third base","Let the ball bounce to you wherever you end up, then look for a play","Go to the wall and try to catch it on the rebound before it hits the ground"],
      best:0,explanations:["Setting up off the wall is the smart play. Position yourself 5-8 feet from the wall so the ball bounces to you at a playable height. Field it with two hands, turn, and hit your cutoff man. This is the fastest, most reliable way to keep the runner from taking an extra base.","Reaching the wall first and trying to throw from there puts you in a terrible position. Your body is facing the wall, you have no momentum toward the infield, and a wild throw from deep center with no cutoff man means the runner might score.","Letting the ball come to you passively means it might bounce past you or die at the base of the wall. You need to be aggressive and set up in the right spot \u2014 not just react to wherever the ball ends up.","Trying to catch the carom before it hits the ground is flashy but risky. The ball bounces unpredictably off the wall. If you miss the snag, the ball rolls away and the runner scores easily. Play it safe with a controlled two-hand pickup."],
      rates:[82,25,20,30],concept:"On balls off the wall, set up a few feet away from the wall to play the carom cleanly \u2014 don't chase the ball to the wall.",anim:"hit"},
    {id:"cf12",title:"Gap Communication",diff:1,cat:"fielder",
      description:"A fly ball is hit into the right-center gap. Both you and the right fielder are running hard toward the same ball. You're the center fielder and you can see you'll get there at about the same time. Nobody has called for it yet.",
      situation:{inning:"Bot 2",outs:2,count:"-",runners:[2],score:[1,0]},
      options:["Call 'I got it! I got it!' loudly and wave off the right fielder","Stay quiet and let the right fielder take it since it's closer to right","Both go for it and whoever gets there first catches it","Slow down and point at the right fielder to take it"],
      best:0,explanations:["The center fielder is the captain of the outfield. On any ball you can reach, you have priority and should call for it loudly and clearly \u2014 at least twice. The right fielder is trained to peel off when they hear you call. This prevents collisions and dropped balls.","Staying quiet is the worst thing you can do. Silence causes collisions. Two outfielders running full speed into each other can cause serious injuries. Someone must communicate, and center field has the priority.","'Whoever gets there first' is how collisions happen. In youth baseball and the pros alike, this is exactly the kind of play that leads to injuries. There must be one clear call and one player backing off.","Slowing down and pointing gives up the play. Hand signals are hard to see when both players are sprinting and focused on the ball. Use your voice \u2014 it's louder and clearer than a gesture."],
      rates:[90,15,10,25],concept:"The center fielder is the captain of the outfield \u2014 call for every ball you can reach, loudly and more than once.",anim:"catch"},
    {id:"cf13",title:"Dive or Play the Hop",diff:3,cat:"fielder",
      description:"Tie game, bottom of the 8th. Runner on second, one out. A sinking line drive is hit to your right in center field. You're sprinting and the ball is dropping fast. If you dive, you might catch it \u2014 or it might skip past you to the wall. If you play it on a hop, the runner scores but you keep the batter to a single.",
      situation:{inning:"Bot 8",outs:1,count:"-",runners:[2],score:[3,3]},
      options:["Play it on a hop \u2014 keep the ball in front of you and limit the damage","Dive for the catch \u2014 a spectacular play ends the threat","Slide feet-first to knock the ball down","Pull up and let it bounce to you, then throw home"],
      best:0,explanations:["With one out in a tie game, the risk of diving and missing is too high. If the ball gets past you, both the runner on second AND the batter score \u2014 you go from a tie to down two. Playing it on a hop gives up one run but keeps the batter at first with two outs coming. Smart center fielders know when the risk isn't worth the reward.","The highlight-reel play feels right, but the math is brutal. If you miss, the ball rolls to the wall and two runs score instead of one. In a tie game with one out, you can't afford to gamble. Diving is the right call with two outs or a bigger lead \u2014 not here.","Feet-first slides in the outfield are dangerous and unpredictable. You can't control where the ball goes, and you're likely to kick it past you. This technique doesn't belong in an outfielder's toolbox.","Pulling up and letting it bounce is too passive \u2014 the ball may scoot past you or take a bad hop. You still need to charge and play it aggressively on the short hop, just without leaving your feet."],
      rates:[85,35,10,40],concept:"In a close game with less than two outs, don't dive unless you're sure \u2014 a ball past the center fielder is a disaster.",anim:"hit"},
    {id:"cf14",title:"Crow-Hop and Throw",diff:2,cat:"fielder",
      description:"Fly ball hit to medium-depth center field. You camp under it and make the catch. Runner on third is tagging up to score. Runner on first is holding. Your arm is decent but the throw home is about 250 feet. The cutoff man is lined up at the mound area.",
      situation:{inning:"Top 5",outs:0,count:"-",runners:[1,3],score:[2,3]},
  ...
  leftField: [
    ...
    {id:"lf1",title:"Hit the Cutoff",diff:1,cat:"fielder",conceptTag:"cutoff-roles",
    ...
    {id:"lf9",title:"Charging a Ground Single",diff:2,cat:"fielder",
      description:"Ground ball single slices through the left side of the infield. Runner on first is rounding second and heading for third. The ball is rolling on the grass toward you in left field. You've got a chance to throw the runner out if you charge hard and field it cleanly.",
      situation:{inning:"Bot 3",outs:1,count:"-",runners:[1],score:[1,2]},
      options:["Charge hard, field the ball outside your glove foot, and throw to third in one motion","Charge, pick it up, set your feet, and make a strong throw to third","Jog in, field it safely, and hold the runner at third with the threat of a throw","Run hard to the ball, barehand it, and fire to third"],
      best:0,explanations:["Charging hard and fielding outside your glove-side foot puts your body in perfect throwing position. You can field and throw in one fluid motion without wasting time setting your feet. This is the outfielder's version of a shortstop's charging play \u2014 momentum toward the target creates a fast, accurate throw.","Stopping to set your feet costs you a full second, and that's the difference between out and safe. By the time you plant and throw, the runner has already slid into third. The charge-and-throw in one motion is what separates great outfielders from average ones.","Jogging in concedes the base. If you don't challenge the runner, they take third every time. With one out, a runner on third scores on a fly ball, a wild pitch, or a passed ball. You have to at least try to get them.","Barehanding a ground ball in the outfield is extremely risky. If you bobble it, the ball rolls behind you and the runner might score. Use your glove \u2014 that's what it's there for. Barehand plays are for infielders on slow rollers, not outfielders."],
      rates:[82,40,25,20],concept:"Charge ground balls aggressively and field outside your glove foot \u2014 this lets you throw in one smooth motion without stopping.",anim:"groundout"},
    {id:"lf10",title:"Backing Up Third Base",diff:1,cat:"fielder",
      description:"Runner on second base tries to steal third. The catcher jumps up and fires a throw to the third baseman. You're the left fielder standing in your normal position. The throw looks a little high and might get past the third baseman.",
      situation:{inning:"Top 5",outs:1,count:"2-1",runners:[2],score:[3,2]},
      options:["Sprint toward the area behind third base in line with the catcher's throw","Stay in your position \u2014 that's the third baseman's play","Run toward the foul line to back up any ball that goes into the stands","Move toward shortstop position to help relay"],
      best:0,explanations:["This is left field's responsibility on every throw to third. Sprint to a spot about 30 feet behind third base, directly in line with the catcher's throw. If the ball gets past the third baseman, you're right there to grab it and keep the runner from scoring. This is a fundamental play that youth coaches love to see.","Staying put is a mistake. If that high throw gets past the third baseman and nobody is backing up, the runner scores on what should have been a simple steal attempt. Left fielders who don't back up third base cost their team runs.","Running to the foul line takes you out of the line of the throw. A backup should always be directly behind the base in line with the throw. The ball won't bounce sideways toward the stands \u2014 it'll skip straight back.","Moving to shortstop position doesn't help on this play at all. The throw is going from the catcher to third base, and you need to be behind third base, not beside it."],
      rates:[88,15,20,12],concept:"The left fielder always backs up third base on throws from the catcher \u2014 sprint behind the bag, in line with the throw.",anim:"steal"},
    {id:"lf11",title:"Lost in the Sun",diff:2,cat:"fielder",
      description:"Afternoon game and the sun is brutal in left field. A high fly ball is hit your way and as you look up, you lose the ball completely in the blinding sun. You had a read on it for a second \u2014 it's coming down somewhere near you. The crowd is yelling.",
      situation:{inning:"Bot 4",outs:0,count:"-",runners:[1],score:[0,1]},
      options:["Use your glove to shade the sun, shift your angle slightly, and try to pick the ball back up","Keep staring straight up into the sun \u2014 you'll find it eventually","Turn away from the sun and listen for your teammates to guide you to the ball","Drop to one knee and let the ball bounce in front of you to play it safe"],
      best:0,explanations:["Using your glove as a sun shield is the textbook move. Hold it up above your eyes to block the sun while shifting your angle a step or two to either side. This often lets you reacquire the ball against a different part of the sky. Sunglasses help, but the glove shade is every outfielder's best friend on sun-field plays.","Staring directly into the sun is dangerous for your eyes and won't help you find the ball. The longer you stare, the worse the spots in your vision become. You need to shade your eyes and change your viewing angle.","Turning away from the ball completely means you have zero chance of catching it. Your teammates can yell, but they can't guide you precisely enough in the 2-3 seconds a fly ball is in the air. You need to keep your eyes in the general area of the ball.","Dropping to a knee is giving up on the play. The ball could land anywhere, and if it bounces over you, runners advance freely. You should always try to track the ball \u2014 shade your eyes and fight to find it."],
      rates:[82,10,30,25],concept:"When you lose a ball in the sun, use your glove to shade your eyes and shift your angle \u2014 never stare directly into the sun.",anim:"flyout"},
    {id:"lf12",title:"Shallow Fly Communication",diff:1,cat:"fielder",
      description:"A soft, looping fly ball is hit into shallow left field. You're running in hard. The shortstop is running out with their back to the infield. You can see the ball clearly the whole way. The shortstop is waving their glove but hasn't called for it.",
      situation:{inning:"Top 2",outs:0,count:"-",runners:[2],score:[0,0]},
      options:["Call 'I got it!' loudly \u2014 you have the better angle coming in on the ball","Stay quiet and let the shortstop take it since they're closer to the infield","Both go for it and figure it out at the last second","Peel off since infielders always have priority"],
      best:0,explanations:["You have the huge advantage here \u2014 you're running in toward the infield and can see the ball the entire way. The shortstop is running with their back to the play, which makes catching much harder. An outfielder coming in always has a better angle than an infielder going out. Call for it loudly and take charge.","Staying quiet causes confusion and collisions. On a ball like this, someone must call for it. Since you have the better angle \u2014 running in with your eyes on the ball \u2014 it should be you. Silence is the enemy.","Going for it without communicating is how players get hurt. Two players colliding at full speed on a shallow fly is one of the most common and dangerous plays in baseball. Call for it or get out of the way.","While infielders generally have priority on balls they can reach, that rule doesn't apply when the outfielder has a clearly better angle. Running in is always easier than running out. An outfielder coming forward should take this ball every time and call off the infielder."],
      rates:[88,15,10,30],concept:"An outfielder running in has a better angle than an infielder running out \u2014 call for the ball and take charge.",anim:"catch"},
    {id:"lf13",title:"Reading the Wall Carom",diff:3,cat:"fielder",
      description:"Scoreless game, runner on first, one out. A screaming line drive hooks toward the left field corner and hits the angled wall where the foul line meets the outfield fence. The ball ricochets hard and shoots back toward center field. You chased it to the corner and now the carom is bouncing away from you.",
      situation:{inning:"Top 7",outs:1,count:"-",runners:[1],score:[0,0]},
      options:["Let the center fielder grab the carom \u2014 redirect and become the relay man between CF and the infield","Chase the ball down yourself even though it's moving away from you","Run to the wall where the ball hit and wait for it to come back","Yell for the third baseman to come get it"],
      best:0,explanations:["This is elite-level awareness. When the carom shoots away from you toward center, the center fielder is in a better position to field it. Your job now changes \u2014 become the relay man. Position yourself between the center fielder and the infield so the throw gets home as fast as possible. This team play can save a run.","Chasing a ball that's bouncing away from you toward center field is a losing race. You're moving in the wrong direction relative to the infield, and every second you chase, the runners advance. Let the center fielder take the shorter path to the ball.","Going back to the wall where the ball originally hit makes no sense \u2014 the ball isn't there anymore. It's already bouncing toward center. You need to react to where the ball IS, not where it WAS. In a scoreless game, every second matters.","The third baseman should be covering third base for a possible play on the lead runner. Asking them to leave their position to chase a ball in the outfield leaves third base empty and gives the runners a free base."],
      rates:[85,25,10,15],concept:"When a carom takes the ball away from you, let a teammate field it and switch to being the relay man \u2014 smart positioning beats foot speed.",anim:"hit"},
    {id:"lf14",title:"Sac Fly Positioning",diff:2,cat:"fielder",
      description:"Runner on third, less than two outs. The batter is a right-handed pull hitter who likes to lift the ball. Your coach signals for you to adjust your positioning. A sacrifice fly will score the run, but if the ball drops for a hit, it's even worse.",
      situation:{inning:"Bot 7",outs:1,count:"-",runners:[3],score:[5,4]},
      options:["Move in a few steps from normal depth \u2014 catch the fly and give yourself a shorter throw home","Play extra deep to make sure nothing gets over your head","Move to your normal depth but shade toward the line since he's a pull hitter","Charge in very shallow, almost to the dirt, to have the shortest possible throw"],
      best:0,explanations:["Moving in a few steps shortens your throw home by 20-30 feet, which could be the difference between the runner being safe or out. You're still deep enough to catch most fly balls, but now your throw has a real chance. This is the smart compromise \u2014 you give yourself a chance at both the catch AND the throw.","Playing extra deep guarantees the runner scores easily on any fly ball. Sure, nothing gets over your head, but the run scores on any catchable fly ball because your throw is too long. In a one-run game, you need to give yourself a chance to throw the runner out.","Shading toward the line is a reasonable idea, but depth matters more than angle here. The main issue isn't where the ball is hit laterally \u2014 it's how long your throw to the plate will be. Moving in a few steps helps more than moving sideways.","Playing extremely shallow is too aggressive. A ball hit over your head in this situation scores the runner AND gives the batter extra bases. You'd turn a sacrifice fly into a run-scoring double or triple. Move in a few steps, not halfway to the infield."],
      rates:[82,20,45,15],concept:"With a runner on third and fewer than two outs, move in a few steps \u2014 shorten your throw home without giving up catchable fly balls.",anim:"throwHome"}
  ],
  firstBase: [
    ...
    {id:"1b6",title:"Turning the 3-6-3 Double Play",diff:3,cat:"fielder",conceptTag:"double-play-turn",
    ...
    {id:"1b8",title:"First-and-Third Pickoff Play",diff:3,cat:"fielder",conceptTag:"first-third",
    ...
    {id:"1b9",title:"Hold Runner, Lefty Batter",diff:2,cat:"fielder",
      description:"You're the first baseman. Tie game, runner on first with decent speed. A left-handed batter steps in — his swing naturally pulls toward right field, right where you normally stand. The pitcher is looking back at the runner, who has a three-step lead.",
      situation:{inning:"Bot 6",outs:1,count:"1-0",runners:[1],score:[3,3]},
      options:["Hold the runner on the bag like normal — stay with your foot on first and give the pitcher a target","Play behind the runner in your normal defensive position since lefties pull the ball to you","Cheat halfway — stand two steps off the bag toward your regular position to split the difference","Hold the runner, but after the pitcher starts his motion, quickly peel off toward your defensive position"],
      best:3,explanations:["Holding the runner on the bag is solid, but with a left-handed pull hitter, staying glued to the bag leaves a massive hole on the right side. A pulled ground ball goes right through where you should be standing.","Playing full depth behind the runner gives him a huge lead and a free stolen base. In a tie game, letting a runner reach scoring position for free is a gift.","Splitting the difference means you're too far off the bag to hold the runner AND too close to the bag to field a pulled grounder. You end up bad at both jobs.","This is the advanced first baseman move. Hold the runner until the pitcher commits home, then quickly release to your fielding position. You keep the runner honest AND cover the hole against the lefty pull hitter."],
      rates:[45,25,30,82],concept:"Against left-handed hitters, hold the runner until the pitcher delivers, then peel off to cover the right side — you need to do both jobs.",anim:"safe"},
    {id:"1b10",title:"Bunt in Front of the Mound",diff:1,cat:"fielder",
      description:"You're the first baseman. Runner on first, no outs. The batter bunts the ball and it dribbles to a stop about 30 feet in front of home plate — right between the mound and the first base line. The pitcher, catcher, and you are all looking at it. Nobody has called for it yet.",
      situation:{inning:"Top 3",outs:0,count:"0-0",runners:[1],score:[1,0]},
      options:["Sprint toward the ball and call 'I got it!' — the first baseman should take charge on bunts","Hang back and let the pitcher or catcher field it since they're closer to the ball","Charge toward the ball but stay quiet and see who gets there first","Sprint toward the ball and call 'I got it!' while pointing at where you want the pitcher to go cover first"],
      best:3,explanations:["Charging and calling for it is great, but if you field the ball, who covers first base? You need someone there to throw to. Communication is everything on bunt plays.","Hanging back means nobody takes charge. The bunt sits there while three players stare at each other and the runners advance. Somebody has to go get the ball.","Charging silently is a recipe for a collision. The pitcher and catcher are also moving toward the ball. Without calling it, two players might crash into each other.","This is the complete play! You call for the ball to avoid collisions, AND you direct the pitcher to cover first base. Now you have someone to throw to after you field the bunt. Communication wins bunt plays."],
      rates:[50,15,20,85],concept:"On bunts, call for the ball AND direct your teammates — tell the pitcher to cover first so you have someone to throw to.",anim:"bunt"},
    {id:"1b11",title:"Scoop the Short-Hop From Third",diff:2,cat:"fielder",
      description:"You're the first baseman. Two outs, runner on second. The batter hits a sharp grounder to the third baseman who backhands it deep behind the bag. He throws hard across the diamond but the ball is going to short-hop you about two feet in front of first base. This is a tougher scoop than a throw from shortstop because the ball has more velocity and a different angle.",
      situation:{inning:"Top 5",outs:2,count:"1-2",runners:[2],score:[2,1]},
      options:["Keep your foot on the bag, stretch toward the throw, and turn your glove to get a forehand scoop on the ball","Stretch out but keep your glove in the backhand position since the ball is coming from the left side","Pull your foot off the bag and use two hands to block the ball and keep it in front of you","Stay upright on the bag and try to short-hop it with your glove at waist height"],
      best:0,explanations:["Textbook! On throws from third base, stretch toward the throw and turn your glove for a forehand scoop. The forehand position keeps your glove pocket open and facing the ball, giving you the best chance to pick the short hop cleanly.","A backhand scoop is harder to control and the ball can kick off the back of your glove. On throws from the left side, rotating to a forehand position gives you a much bigger scooping surface.","Pulling your foot off the bag means even if you catch it, the runner is safe. With two outs you need this out — keep your foot on the base and make the scoop.","Short hops don't bounce up to waist height from two feet away. The ball stays low. You need to get your glove down to the dirt to scoop it, not wait for it to come up to you."],
      rates:[82,40,30,15],concept:"On short-hop throws from third base, stretch and rotate your glove to the forehand position — the bigger scooping surface gives you the best chance.",anim:"groundout"},
    {id:"1b12",title:"3-6-3 Double Play — Quick Feet",diff:3,cat:"fielder",
      description:"You're the first baseman in a tied game. Runner on first, no outs. The batter hits a hard grounder right at you. You field it cleanly just in front of the bag. The shortstop is already breaking for second base to cover. The runner from first has only taken two steps — he got a bad jump. You have time, but you need to execute perfectly.",
      situation:{inning:"Bot 5",outs:0,count:"0-0",runners:[1],score:[2,2]},
      options:["Throw to the shortstop covering second, then sprint back to first base for the return throw","Step on first base to get the batter out, then throw to second for the runner","Hold the ball, tag first base, and let the team settle for one out","Flip to the pitcher covering first, then let the pitcher throw to second"],
      best:0,explanations:["This is the 3-6-3 double play executed perfectly! Throw to the shortstop for the force at second, then hustle back to first for the return throw. Getting the lead runner first keeps the force play alive at both bases. Two outs, inning over.","Stepping on first REMOVES the force at second base. Now instead of the shortstop just touching second, he has to tag the runner — which is much harder and slower. Always get the lead runner first when turning two.","Settling for one out when you have a chance to end the inning with a double play wastes an opportunity. In a tie game with no outs, a double play completely changes the momentum.","The pitcher covering first adds an unnecessary relay. You're RIGHT THERE at first base — you can get back to the bag faster than the pitcher can get there. The 3-6-3 is your play."],
      rates:[85,30,35,20],concept:"On the 3-6-3 double play, always throw to second FIRST to keep the force play alive — stepping on first first kills the force at second.",anim:"doubleplay"},
    {id:"1b13",title:"Play Back or Hold — Tie Game",diff:2,cat:"fielder",
      description:"You're the first baseman. Bottom of the 7th in a tie game. Runner on first, no outs, and the batter is the opposing team's best power hitter. The runner on first is slow — a catcher who's only stolen two bases all season. Your pitcher has a good pickoff move.",
      situation:{inning:"Bot 7",outs:0,count:"0-0",runners:[1],score:[3,3]},
      options:["Hold the runner on the bag like you always do when there's a runner on first","Play behind the runner at your normal depth — the power hitter is the bigger threat","Play in closer to home plate to cut off a ground ball through the right side","Shade toward the foul line to prevent an extra-base hit down the line"],
      best:1,explanations:["With a slow runner who almost never steals and a pitcher with a good pickoff move, holding the runner on the bag sacrifices your defensive range for nothing. The runner isn't going anywhere.","Smart! A slow runner with only two steals isn't a threat. Playing at your normal depth gives you much better range to field ground balls from the power hitter. Your pitcher's pickoff move keeps the runner honest without your help.","Playing in makes sense for bunt defense, but a power hitter isn't bunting. Moving in just makes hard ground balls reach you faster, giving you less reaction time.","Shading the line could work late in a game, but with no outs and a runner on first, taking away the right-side hole is more valuable. A ground ball through the right side advances the runner to third — a single down the line does too, but it's less likely."],
      rates:[40,82,25,35],concept:"When the runner on first is slow and not a stolen base threat, play at normal depth to maximize your defensive range against the batter.",anim:"groundout"},
    {id:"1b14",title:"Picking the Ball in the Dirt",diff:1,cat:"fielder",
      description:"You're the first baseman. Routine ground ball to the second baseman with a runner on first and one out. The second baseman makes the throw but it bounces in the dirt about five feet in front of you — a classic short hop. You can see the ball clearly and the batter is still a few steps from first base.",
      situation:{inning:"Top 4",outs:1,count:"0-0",runners:[1],score:[0,2]},
      options:["Keep your foot on the bag, stretch toward the throw, bend your knees, and scoop your glove along the ground like you're sweeping the dirt","Stay upright and try to catch the ball after it bounces up to you","Pull your foot off the bag so you can move freely to block the ball","Close your eyes and stab at where you think the ball will be"],
      best:0,explanations:["Perfect form! Keeping your foot on the bag maintains the force out. Stretching toward the throw catches the ball sooner, before the hop gets unpredictable. Bending low and sweeping the glove along the ground gives you the best chance to scoop it cleanly.","Staying upright means the ball could bounce under your glove or skip past you. Short hops stay low — you need to get down to the ball's level, not wait for it to come up to yours.","Pulling your foot off the bag means there's no force out even if you catch the ball perfectly. The whole point of first base is keeping your foot on the bag while making the catch.","Never close your eyes! You need to watch the ball all the way into your glove. Closing your eyes and guessing leads to errors and potential injuries from getting hit by the ball."],
      rates:[88,30,20,10],concept:"Scooping throws in the dirt is a first baseman's signature skill — keep your foot on the bag, stretch toward the throw, and sweep your glove low along the ground.",anim:"groundout"},
  ],
  rightField: [
    ...
    {id:"f11",title:"Backing Up Bases",diff:1,cat:"positioning",conceptTag:"backup-duties",
    ...
    {id:"rf9",title:"Ball Down the Right Field Line",diff:1,cat:"fielder",
      description:"You're the right fielder. The batter slashes a hard ground ball down the right field line. It's hugging the foul line and rolling fast toward the corner. There's a runner on first who is already sprinting toward second. You need to get to the ball quickly and make a smart play.",
      situation:{inning:"Bot 3",outs:1,count:"1-0",runners:[1],score:[1,2]},
      options:["Angle your run toward the foul line side so you can field the ball and already be facing the infield for your throw","Run straight at the ball and then spin around to throw after you pick it up","Let the ball roll and see if it goes foul — it's close to the line","Jog toward the ball to save energy for the throw"],
      best:0,explanations:["Angling toward the line puts your body in position to field the ball and make a throw in one fluid motion. You're already facing the infield when you pick it up, saving a full turn. That saved time can be the difference between a double and holding the runner at second.","Running straight at the ball means your momentum carries you away from the infield. You have to stop, spin, and then throw — that extra time lets the runner take an extra base.","Hoping a ball goes foul is never a plan. If it stays fair and you waited, the runner is rounding third. Always play the ball as if it's fair until it isn't.","Jogging to a live ball in play is unacceptable. The runner is sprinting — you need to match his urgency. Every step you jog is an extra base for the other team."],
      rates:[85,40,15,10],concept:"On balls down the right field line, angle your approach so you're already facing the infield when you field the ball — it saves a full turn on your throw.",anim:"catch"},
    {id:"rf10",title:"Backing Up First on a Throw From Third",diff:1,cat:"fielder",
      description:"You're the right fielder. The batter hits a slow roller to the third baseman, who bare-hands it and fires a long throw across the diamond to first base. There are no other runners on base. You're playing at normal depth and watching the play develop.",
      situation:{inning:"Top 5",outs:0,count:"0-0",runners:[],score:[2,2]},
      options:["Sprint toward the foul territory behind first base to back up the throw from third","Stay in right field and watch — it's a routine play","Run toward second base in case the batter tries to stretch for a double","Move toward center field to cover more ground"],
      best:0,explanations:["Long throws from third base are the most likely to pull the first baseman off the bag or skip past him. Backing up first base on throws from the left side of the infield is one of your most important responsibilities as a right fielder.","A throw from deep behind third base is 130+ feet across the diamond. That's a long, hard throw that can sail or bounce. If nobody backs it up and it gets past the first baseman, the runner takes second or third for free.","The batter is trying to beat out a grounder to first — he's not going to second unless there's an error. Your job is to prevent the error from becoming a disaster by backing up first.","Moving toward center leaves first base completely unprotected. An overthrow rolls to the fence and turns a routine groundout into a runner on second or third."],
      rates:[88,15,20,10],concept:"The right fielder must back up first base on throws from the left side of the infield — long throws from third are the most likely to get past the first baseman.",anim:"advance"},
    {id:"rf11",title:"Cutoff Man or Throw Home Direct",diff:3,cat:"fielder",conceptTag:"cutoff-roles",
      description:"You're the right fielder. Bottom of the 8th, one-run game. Runner on second, one out. The batter singles sharply to right field and you charge in to field it cleanly on one hop. The runner from second is rounding third and heading home. You're about 250 feet from home plate. You have a strong arm — you can reach home on the fly from 250 feet, but it won't be your most accurate throw. The first baseman is lined up as the cutoff man at about 130 feet from you.",
      situation:{inning:"Bot 8",outs:1,count:"2-1",runners:[2],score:[4,3]},
      options:["Throw home directly — your arm is strong enough and this is a do-or-die situation","Hit the cutoff man with a chest-high throw so he can relay it home or redirect","Throw to second base to keep the batter from advancing into scoring position","Hold the ball and concede the run since the runner has too big a head start"],
      best:1,explanations:["Your arm CAN reach home, but a 250-foot throw under pressure is likely to tail, bounce, or miss the catcher entirely. If it gets past the catcher, the batter takes second or third. One bad throw costs you more than the run.","Hitting the cutoff man with a strong, accurate throw gives your team the best chance. The relay can reach home faster and more accurately than your long throw, and the cutoff man can redirect if the play at home is too late. This keeps all options alive.","Throwing to second concedes the tying run without a fight. In a one-run game with one out, you have to at least try to get the runner at home.","Conceding the run without making a throw lets the other team tie the game for free. You fielded the ball cleanly — make a play. A throw to the cutoff man at least puts pressure on the runner."],
      rates:[35,82,20,15],concept:"In pressure situations, hitting the cutoff man is smarter than a hero throw — accurate relay throws beat long, risky heaves to the plate.",anim:"throwHome"},
    {id:"rf12",title:"Fly Ball With Wind Blowing In",diff:2,cat:"fielder",
      description:"You're the right fielder. A high fly ball is hit to medium-deep right field. Before the game, your coach told you the wind is blowing straight in from right field at about 15 mph. The ball looks like a routine fly at first, but you can see it starting to hang in the air and slow down. There's a runner on third with one out.",
      situation:{inning:"Top 6",outs:1,count:"0-2",runners:[3],score:[3,2]},
      options:["Play it where you think it was hit and wait for the ball to come down to you","Take a few steps IN from where the ball was hit because the wind will knock it down short","Drift BACK a few steps because wind can be tricky and you don't want it over your head","Charge in hard and try to make a diving catch"],
      best:1,explanations:["Wind blowing in at 15 mph can knock 20-30 feet off a fly ball. If you stay where the ball was originally hit, it will drop in front of you for a hit. You have to adjust your positioning to where the ball will actually land.","Exactly right! Wind blowing in will hold the ball up and push it back toward the infield. Take a few steps in so the ball comes down to you instead of dropping in front of you. Read the wind and adjust.","Drifting back when the wind is blowing IN is the worst adjustment. The wind pushes the ball TOWARD you, not away. Going back means the ball falls 30 feet in front of you.","Charging in hard and diving is reckless when you can simply take a few calm steps in and catch the ball at your chest. Diving creates a chance for the ball to get past you and the runner on third to score."],
      rates:[30,85,15,35],concept:"When the wind blows in, fly balls lose distance — adjust your positioning a few steps toward the infield to catch the ball where it actually lands.",anim:"catch"},
    {id:"rf13",title:"Cut Off the Extra Base to the Gap",diff:2,cat:"fielder",
      description:"You're the right fielder. The batter drives a hard line drive into the right-center field gap. The ball splits the gap and is rolling to the wall. A runner on first is sprinting hard. The center fielder is also chasing the ball but you're closer. If you get to the ball quickly, you might hold the runner to third instead of letting him score.",
      situation:{inning:"Top 4",outs:0,count:"1-1",runners:[1],score:[0,0]},
      options:["Sprint to the ball at full speed, pick it up, and fire to the cutoff man lined up between you and third base","Let the center fielder handle it since gap balls are usually the center fielder's responsibility","Jog to the ball since the extra base is already given up","Sprint to the ball, pick it up, and throw directly home to try to get the runner"],
      best:0,explanations:["Getting to the ball fast and hitting your cutoff man is the smart play. The cutoff man can relay to third to hold the runner or redirect home. Your urgency to the ball saves the extra base — every second counts.","The ball is closer to you than the center fielder. When you're closer, the ball is YOURS regardless of who normally covers the gap. Waiting for the center fielder wastes precious seconds.","Jogging to any ball in play is never acceptable. The runner is sprinting at full speed — if you jog, he scores standing up. Hustle to the ball and you might hold him at third.","Throwing directly home from deep right-center is an extremely long throw. Even with a strong arm, the ball bounces multiple times and arrives too late. Hitting the cutoff man gets the ball to the right base faster."],
      rates:[82,25,10,30],concept:"On gap hits, the closest outfielder sprints to the ball and hits the cutoff man — urgency prevents extra bases and keeps runners from scoring.",anim:"throwHome"},
    {id:"rf14",title:"Charge the Shallow Fly for the Throw",diff:3,cat:"fielder",
      description:"You're the right fielder. Top of the 9th, runner on third, one out, tied game. The batter lofts a shallow fly ball to medium-right field — deep enough that the runner on third will tag up. You're charging in and you know this will be close. If you catch it, the runner will tag and try to score the winning run. You need to decide how to position your body WHILE catching the ball.",
      situation:{inning:"Top 9",outs:1,count:"1-1",runners:[3],score:[4,4]},
      options:["Catch the ball on your glove side while running in, crow-hop, and fire home in one motion","Drift under the ball and catch it standing still to make sure you don't drop it, then throw","Charge in and catch it on the run, but immediately throw to the cutoff man instead of home","Let the ball drop on purpose so the runner can't tag up — play it on the bounce instead"],
      best:0,explanations:["This is the elite outfield play! Catching on your glove side while moving forward gives you momentum toward home. The crow-hop transfers that momentum into your throw. You catch AND throw in one fluid motion, giving the runner the least possible time.","Stopping to catch the ball kills your momentum. You'll be throwing from a standstill, which gives the runner an extra two seconds to tag and score. In a tie game with the winning run, those seconds are everything.","The cutoff man adds a relay step that eats precious time. On a shallow fly ball, you're close enough to throw home directly. The relay is for deep flies when you can't reach home — not for shallow catches.","Letting a catchable fly ball drop intentionally is risky. The ball could take a bad hop, roll past you, or you might bobble it. You also give up a guaranteed out. A caught fly ball with a throw home gives you two chances for an out."],
      rates:[82,40,30,15],concept:"On shallow sacrifice fly attempts, catch the ball on the move with momentum toward home — the crow-hop throw gives the runner the least time to tag and score.",anim:"throwHome"},
  ],
  thirdBase: [
    ...
    {id:"3b4",title:"Guard the Line",diff:1,cat:"fielder",conceptTag:"cutoff-roles",
    ...
    {id:"3b9",title:"Bare-Hand the Slow Roller",diff:2,cat:"fielder",
      description:"You're the third baseman. Bottom of the 4th, runner on second, one out. The batter chops a slow roller down the third base line. The ball is dying on the grass about 25 feet from you and barely spinning. The batter is fast — he's already three steps out of the box. You need to decide how to field this ball and where to throw.",
      situation:{inning:"Bot 4",outs:1,count:"2-1",runners:[2],score:[1,2]},
      options:["Charge hard, bare-hand the ball, and fire to first base in one motion","Charge hard, field it with your glove, transfer to your throwing hand, then throw to first","Charge in but look the runner back to second before throwing to first","Hold your position and wait for the ball to roll closer to you"],
      best:0,explanations:["On a dying roller, bare-handing saves the split second of glove-to-hand transfer. You scoop it with your throwing hand and fire to first in one seamless motion. With a fast runner, that saved time is the difference between out and safe.","Fielding with your glove is safer for catching, but the transfer from glove to hand takes too long. On a slow roller with a fast runner, you need every millisecond. The bare hand is the play here.","Looking the runner back is a good instinct, but with one out and a fast batter, you don't have time to check the runner AND throw out the batter. Get the sure out at first — the runner on second isn't going home on a slow roller to third.","Waiting for a dying roller is a death sentence. The ball is barely moving — it might stop completely before it reaches you. Meanwhile the batter is sprinting to first. Attack the ball!"],
      rates:[82,50,35,10],concept:"On slow rollers, bare-handing eliminates the glove transfer and lets you throw in one continuous motion — every split second counts.",anim:"groundout"},
    {id:"3b10",title:"Tag the Runner at Third",diff:1,cat:"fielder",conceptTag:"force-vs-tag",
      description:"You're the third baseman. Runner on second, no outs. The batter singles to left field and the runner rounds third hard. The left fielder throws to you at third base and the runner decides to come back. He's sliding into the bag headfirst. You catch the throw and need to apply the tag.",
      situation:{inning:"Top 5",outs:0,count:"0-0",runners:[2],score:[2,3]},
      options:["Catch the ball and sweep your glove down low in front of the bag to tag the runner's hands before they reach the base","Catch the ball and try to tag the runner on the back as he slides","Catch the ball, hold it up for the umpire to see, then apply the tag","Stand on top of the bag and wait for the runner to slide into your feet"],
      best:0,explanations:["On a headfirst slide back to the bag, the runner's hands are reaching for the base. Sweeping your glove low in front of the bag meets his hands BEFORE they touch the base. This is the textbook tag on a headfirst slide.","Tagging the runner's back on a headfirst slide is difficult because his hands reach the base before his back arrives at the tag point. You need to tag the part of his body that arrives first — his hands.","Showing the ball to the umpire before tagging is a waste of time. The runner will be safe by the time you finish showing off. Tag first, appeal later if needed.","Standing on the bag blocks the runner's path and could cause a collision or interference call. You need to let the runner access the base and apply a clean tag."],
      rates:[88,35,15,20],concept:"On headfirst slides, sweep the tag low in front of the bag — meet the runner's hands before they reach the base.",anim:"catch"},
    {id:"3b11",title:"Cut Off the Throw From Left",diff:2,cat:"fielder",
      description:"You're the third baseman. Runner on first, one out. The batter doubles into the left field corner. The runner from first is rounding second and heading to third. The left fielder picks up the ball and throws it toward the infield. You're positioned between third base and the left fielder. The throw is coming at you about head height, and you need to decide: cut it off or let it go through to the catcher?",
      situation:{inning:"Bot 6",outs:1,count:"1-2",runners:[1],score:[3,4]},
      options:["Let the throw go through to the catcher — the runner from first might try to score","Cut the ball off and tag the runner coming into third","Cut the ball off and hold it — check all the runners before deciding where to throw","Listen for the catcher's call — he'll yell 'cut' or 'let it go' based on what he sees"],
      best:3,explanations:["Automatically letting the throw go through could be wrong. If the runner stops at third, the throw sails past the catcher for nothing and the batter advances.","Cutting it off and tagging third could work, but you don't know where all the runners are while facing the outfield. You might miss a better play.","Cutting and holding is safe but passive. If the runner IS going home, you just killed the play at the plate by holding the ball too long.","The catcher can see the entire field from his position — he sees where every runner is. He'll shout 'CUT' if you should catch it, or stay quiet if the throw should go through. Trust his eyes and react to his voice."],
      rates:[35,40,30,82],concept:"On cutoff plays, listen to your catcher — he sees the whole field and will tell you to cut or let it through based on where the runners are.",anim:"throwHome"},
    {id:"3b12",title:"Bunt Defense — Charge and Throw",diff:1,cat:"fielder",
      description:"You're the third baseman. Bottom of the 3rd, runner on first, no outs. The batter squares to bunt and pushes it toward the left side — the ball rolls about 20 feet up the third base line. The ball has some pace on it and is rolling right toward you as you charge in. The second baseman is covering first.",
      situation:{inning:"Bot 3",outs:0,count:"0-0",runners:[1],score:[0,1]},
      options:["Charge in, field it with your bare hand, and throw to first for the sure out","Charge in, field it with your bare hand, and throw to second to get the lead runner","Let the ball come to you at your normal depth, then throw to first","Charge in, pick it up, and run toward first base to make a shorter throw"],
      best:0,explanations:["Charge aggressively, bare-hand the rolling ball, and fire to first for the guaranteed out. The bunt has pace on it so you'll be close enough for a strong throw. Getting the sure out is the smart play on bunt defense.","Throwing to second for the lead runner sounds great, but after charging forward on a bunt, your momentum is going the wrong way for a throw to second. It's a much harder throw and you risk throwing it away.","Waiting for the ball at normal depth gives the batter too much time to reach first. On bunt defense, you must charge in aggressively to have any chance of making the play.","Running toward first base wastes time and makes your throw awkward. A strong throw from where you field the ball is faster than jogging closer and then throwing. Use your arm, not your legs."],
      rates:[85,35,15,25],concept:"On bunt plays, charge aggressively and throw to first for the sure out — don't try for the lead runner when your momentum is going the wrong way.",anim:"bunt"},
    {id:"3b13",title:"Hot Corner Line Drive",diff:3,cat:"fielder",
      description:"You're the third baseman. Top of the 8th, one-run game. A right-handed power hitter smashes a screaming line drive right at you, about chest high. The ball is on you in less than a second — there's almost no time to think. You're playing at normal depth, about 90 feet from home plate. Your reflexes take over.",
      situation:{inning:"Top 8",outs:0,count:"1-0",runners:[1,2],score:[5,4]},
      options:["React with your glove — keep your glove open, centered on your body, and try to snare it","Duck out of the way — self-preservation comes first on a ball hit that hard","Knock the ball down with your body to keep it in front of you, then pick it up and throw","Try to backhand it since the ball is slightly to your glove side"],
      best:0,explanations:["On a screaming liner, keeping your glove centered and open gives you the biggest target. You react with soft hands and let the ball hit the glove rather than stabbing at it. At 90 feet, you have just enough time to react if your glove is ready.","Ducking gives the batter a free hit and runners advance. Third basemen are taught to keep their glove in front of their body on every pitch. The 'hot corner' requires courage — you'll face hard-hit balls regularly.","Intentionally using your body to block a line drive is painful and unnecessary when you can use your glove. Your glove is designed to catch the ball — your chest is not. Plus a body block might deflect the ball away and you can't make a throw.","A backhand on a ball coming at 100+ mph gives you less glove surface and less control. Center your glove in front of your body with the pocket open — maximum catching area for maximum reaction time."],
      rates:[80,10,40,30],concept:"At the hot corner, keep your glove centered and ready on every pitch — react with soft hands and let the ball hit the glove rather than stabbing at it.",anim:"catch"},
    {id:"3b14",title:"Cover Third on a Steal From Second",diff:2,cat:"fielder",
      description:"You're the third baseman. Runner on second, one out, and the runner has been taking aggressive leads all game. The pitcher is in the stretch. As the pitcher starts his delivery, you see the runner from second break toward third base — he's stealing! The shortstop yells 'He's going!' The catcher catches the pitch and fires a throw to third.",
      ...
      rates:[85,15,20,25],concept:"On steals of third, the third baseman covers the bag — straddle it, catch the throw, and sweep the tag down on the runner's feet.",anim:"catch"},
  ],
  baserunner: [
    {id:"r1",title:"Stealing Second",diff:1,cat:"stealing",conceptTag:"steal-breakeven",
    ...
    {id:"r2",title:"Tag Up Deep Fly",diff:1,cat:"tagging",conceptTag:"tag-up",
    ...
    {id:"r14",title:"Fast but Strong-Armed Catcher",diff:1,cat:"stealing",conceptTag:"steal-breakeven",
    ...
    {id:"r27",title:"Line Drive — Freeze!",diff:2,cat:"tagging",conceptTag:"tag-up",
    ...
    {id:"r28",title:"Sacrifice Fly Timing",diff:2,cat:"tagging",conceptTag:"tag-up",
    ...
    {id:"r30",title:"Foul Ball Tag-Up",diff:3,cat:"tagging",conceptTag:"tag-up",
    ...
    {id:"r47",title:"Hit and Run — Batter Misses",diff:2,cat:"baserunning",conceptTag:"hit-and-run",
    ...
    {id:"r51",title:"Rundown — Make Them Throw",diff:3,cat:"baserunning",conceptTag:"rundown-mechanics",
    ...
    {id:"r53",title:"Infield Fly Rule — What Do I Do?",diff:2,cat:"rules",conceptTag:"infield-fly",
  ...
  manager: [
    ...
    {id:"m26",title:"Steal or Hit and Run?",diff:2,cat:"plays",conceptTag:"hit-and-run",
    ...
    {id:"m35",title:"Pull Hitter at the Plate — Shift?",diff:2,cat:"defense",conceptTag:"dp-positioning",
    ...
    {id:"m39",title:"Power Hitter Up — DP or Guard Lines?",diff:3,cat:"defense",conceptTag:"dp-positioning",
  ...
  catcher: [
    ...
    {id:"ct3",title:"Steal Attempt at 2nd",diff:2,cat:"throwing",conceptTag:"steal-breakeven",
    ...
    {id:"ct21",title:"Ball in the Dirt, Strike Three!",diff:2,cat:"catcher",
      description:"You're the catcher. Curveball hits the dirt for strike three! With two outs and first base open, you have a split second to react. The batter is already starting toward the dugout.",
      situation:{inning:"Bot 6",outs:2,count:"1-2",runners:[2],score:[3,3]},
      options:["Scramble for the ball and throw to first — the batter can run!","Hold the ball — that's strike three, the batter is automatically out","Throw to third to hold the runner","Appeal to the umpire — you need a ruling before throwing"],
      best:0,explanations:["Great reaction! With 2 outs and first base empty, a dropped third strike lets the batter run to first. Recover that ball and throw to first immediately — it's a live play!","With 2 outs and first base empty, the batter is NOT automatically out on a dropped third strike. The catcher must either tag the batter or throw to first. This is one of the trickiest rules in baseball!","The runner on second isn't going anywhere — the batter running to first is the urgent play. Get the ball to first base before the batter gets there.","There's no appeal needed — the umpire already called strike three. The play is live and it's YOUR job to complete the out by tagging the batter or throwing to first."],
      rates:[85,15,10,25],concept:"With 2 outs and first base empty, a dropped third strike lets the batter run — always recover the ball and throw to first.",anim:"groundout",conceptTag:"dropped-third-strike"},
    {id:"ct22",title:"Runner on First Complicates It",diff:3,cat:"catcher",
      description:"You're the catcher. Strike three in the dirt! The runner on first breaks for second on contact. But there's already a runner on first base and only one out. Do you chase the ball?",
      situation:{inning:"Top 4",outs:1,count:"2-2",runners:[1],score:[2,1]},
      options:["Recover and throw to first immediately","The batter is out — the dropped third strike rule doesn't apply with a runner on first and fewer than 2 outs","Tag the batter with the ball before he leaves the box","Throw to second to catch the stealing runner"],
      best:1,explanations:["You don't need to throw to first! With a runner on first and fewer than 2 outs, the batter is automatically out on strike three regardless of whether you catch it. Throwing to first wastes time.","Exactly right! The dropped third strike rule does NOT apply when first base is occupied with fewer than 2 outs. This prevents the defense from intentionally dropping a third strike to start a double play. The batter is out — now focus on the runner stealing second.","You don't need to tag the batter — he's already out! With a runner on first and one out, the dropped third strike exception applies. Save your energy for the runner going to second.","Good instinct to throw out the stealing runner, but recognize the batter is already out first. The dropped third strike rule doesn't apply here, so the batter is out on strikes. Now you can focus entirely on throwing out the runner at second."],
      rates:[20,85,35,45],concept:"With a runner on first and fewer than 2 outs, the dropped third strike rule does NOT apply — the batter is out to prevent easy double plays.",anim:"strike",conceptTag:"dropped-third-strike"},
  ...
  famous: [
    ...
    {id:"fp11",title:"The Catch",diff:3,cat:"famous",
    ...
    {id:"fp12",title:"Buckner's Grounder",diff:2,cat:"famous",
      ...
      rates:[85,25,12,30],concept:"In pressure moments, trust the fundamentals \u2014 stay low, glove on the ground, field it clean. Routine plays win championships.",anim:"groundout"},
    {id:"fp13",title:"Gibson's Moment",diff:2,cat:"famous",
      ...
      rates:[87,35,20,10],concept:"Great hitters study the pitcher's tendencies. Kirk Gibson knew what pitch was coming and was ready for it \u2014 preparation is a superpower.",anim:"hit"},
    {id:"fp14",title:"Koufax's Decision",diff:3,cat:"famous",
    ...
    {id:"fp15",title:"Jackie Steals Home",diff:2,cat:"famous",
      ...
      rates:[82,45,30,20],concept:"Jackie Robinson played baseball with fearless courage \u2014 the same courage that made him a pioneer who changed the game forever.",anim:"steal"},
    {id:"fp16",title:"The Pine Tar Game",diff:1,cat:"famous",
      ...
      rates:[85,40,15,10],concept:"The Pine Tar Incident taught baseball that rules should focus on fair play, not technicalities. Pine tar helps grip \u2014 it doesn't help you hit farther.",anim:"hit"},
    {id:"fp17",title:"Carter's Walk-Off",diff:2,cat:"famous",
      ...
      rates:[85,30,25,10],concept:"In the biggest moments, study the pitcher's weaknesses and be ready to attack. Joe Carter's World Series walk-off was all about knowing what was coming.",anim:"hit"},
    {id:"fp18",title:"Ripken's Record",diff:1,cat:"famous",
      ...
      rates:[90,25,35,20],concept:"Cal Ripken Jr. proved that showing up every day and giving your best is one of the greatest achievements in all of sports.",anim:"safe"},
    {id:"fp19",title:"Clemente's 3000th",diff:1,cat:"famous",
      ...
      rates:[88,15,25,30],concept:"Roberto Clemente played baseball with pride and purpose, and used his fame to help others. He showed that being a great person matters more than being a great player.",anim:"hit"},
    {id:"fp20",title:"Shot Heard Round the World",diff:3,cat:"famous",
  ...
  rules: [
    ...
    {id:"rl9",title:"Infield Fly Rule",diff:2,cat:"rules",conceptTag:"infield-fly",
      description:"Runners on first and second with one out. The batter pops up a high fly ball to the shortstop area. The umpire immediately points up and yells 'Infield fly!' before the ball even comes down. The shortstop lets the ball drop on purpose. What happens?",
      situation:{inning:"Top 5",outs:1,count:"1-2",runners:[1,2],score:[2,3]},
      options:["The batter is out automatically \u2014 the infield fly rule protects the runners","The ball is dead and all runners return to their bases","It's a live ball and the shortstop can throw to second for a double play","The batter gets to run to first because the fielder dropped it on purpose"],
      best:0,explanations:["Correct! The infield fly rule says that when there are runners on first and second (or bases loaded) with less than two outs, a pop fly that an infielder can catch with ordinary effort makes the batter automatically out \u2014 even if the fielder drops it. This prevents fielders from intentionally dropping easy pop-ups to turn double plays on confused runners.","The ball is NOT dead on an infield fly. It's still a live ball, and runners can advance at their own risk. They just aren't forced to run because the batter is already out. This is a common misconception about the rule.","Since the batter is already out due to the infield fly call, there's no force play anymore. The runners can stay on their bases safely. The whole point of the rule is to prevent this kind of trickery.","The batter is out regardless of whether the fielder catches it. That's the entire purpose of the infield fly rule \u2014 to protect the offense from fielders who might deliberately drop an easy fly ball."],
      rates:[85,30,15,25],concept:"The infield fly rule protects runners from being tricked. When called, the batter is automatically out even if the fielder drops the ball on purpose.",anim:"flyout"},
    {id:"rl10",title:"Tagging on Fouls",diff:1,cat:"rules",
      description:"Runner on third base with one out. The batter hits a deep fly ball down the right field line, but it curves foul. The right fielder makes a nice running catch in foul territory. The runner on third wants to tag up and score. Is this allowed?",
      situation:{inning:"Bot 7",outs:1,count:"0-0",runners:[3],score:[3,4]},
      options:["Yes \u2014 runners CAN tag up and advance on a caught foul ball","No \u2014 runners must stay on their base after a foul ball is caught","Only if the foul ball was caught in fair territory","Only if the umpire gives special permission"],
      best:0,explanations:["Correct! A caught foul ball is just like a caught fair ball for tagging up. Once the fielder catches it, runners can tag their base and advance at their own risk. This is a smart play \u2014 if the foul ball is caught deep enough, the runner can score! Sacrifice flies can happen on foul balls too.","This is a common myth! Runners absolutely can tag up on caught foul balls. Any time a fly ball is caught \u2014 fair or foul \u2014 runners may tag up and advance. This is especially important for runners on third.","It doesn't matter where the fielder is standing when catching a foul ball. Fair or foul territory, a catch is a catch. Runners can tag up on any caught fly ball regardless of where the fielder is.","The umpire doesn't need to give permission for a tag-up. It's the runner's right to tag and advance on any caught fly ball. The runner just needs to touch the base after the catch before running."],
      rates:[88,25,20,10],concept:"Runners can tag up and advance on ANY caught fly ball \u2014 fair or foul. A deep foul ball catch can turn into a sacrifice fly!",anim:"score"},
    {id:"rl11",title:"Ball Hits a Runner",diff:2,cat:"rules",
      description:"Runner on second base, no outs. The batter hits a sharp ground ball up the middle. The ball passes the pitcher and hits the runner standing on the basepath between second and third. No fielder had a chance to make a play on the ball. What's the call?",
      situation:{inning:"Top 3",outs:0,count:"2-1",runners:[2],score:[1,0]},
      options:["The runner is out, the batter gets first base, and the ball is dead","The ball is still live \u2014 play continues as normal","Both the runner and batter are out \u2014 double play","The batter is out because the hit ball was interfered with"],
      best:0,explanations:["Correct! When a batted ball hits a runner in fair territory before passing a fielder (other than the pitcher), the runner is out, the ball is dead, and the batter is awarded first base. It doesn't matter if the runner tried to avoid the ball. This prevents runners from intentionally getting in the way of ground balls.","The ball is NOT live when it hits a runner. It becomes dead immediately. If the ball were still live, runners could deliberately get hit by ground balls to break up plays or cause confusion.","Only the runner who was hit is called out. The batter is awarded first base, not called out. You can't penalize the batter for something the runner did (or couldn't avoid).","The batter did nothing wrong \u2014 they hit a fair ball. The runner happened to be in the path. The batter is rewarded with first base, not punished with an out."],
      rates:[82,20,15,25],concept:"If a batted ball hits a runner before passing a fielder, the runner is out and the ball is dead. The batter gets first base.",anim:"groundout"},
    {id:"rl12",title:"Dropped Third Strike",diff:2,cat:"rules",
      description:"Two outs, nobody on base. The pitcher throws a nasty curveball for strike three, but the ball bounces in the dirt and gets away from the catcher. The batter starts to walk back to the dugout. The catcher hasn't picked up the ball yet. What should the batter do?",
      situation:{inning:"Bot 6",outs:2,count:"1-2",runners:[],score:[2,2]},
      options:["Run to first base! On a dropped third strike, the batter can try to reach first safely","Walk to the dugout \u2014 strike three means you're out no matter what","Wait for the umpire to tell you whether to run or not","Stay in the box and ask for another pitch since the catcher dropped it"],
      best:0,explanations:["Correct! On a dropped third strike, the batter can run to first base if first base is unoccupied or there are two outs. The catcher must either tag the batter or throw to first to complete the out. Many runners have reached base this way \u2014 never assume you're out! Always run on a ball in the dirt with two strikes.","Never walk to the dugout on a dropped third strike! This is one of the most important rules to know. If the catcher doesn't catch strike three cleanly, you have a chance to reach base. Always be alert and run!","Don't wait for the umpire \u2014 just run! The umpire will signal strike three, but it's YOUR job to know the dropped third strike rule and take off for first base. Time is everything here.","You don't get an extra pitch. Strike three is still strike three \u2014 but if the catcher drops it, the play isn't over. You need to beat the throw to first base to be safe, just like on a ground ball."],
      rates:[88,12,20,15],concept:"On a dropped third strike, the batter can run to first if it's unoccupied or there are two outs. Never walk away \u2014 always run!",anim:"safe"},
    {id:"rl13",title:"What's a Balk?",diff:1,cat:"rules",
      description:"Runner on first base with no outs. The pitcher starts his windup but suddenly stops and doesn't throw the ball. The umpire immediately calls 'Balk!' The runner on first looks confused. What happens when a balk is called?",
      situation:{inning:"Top 4",outs:0,count:"2-1",runners:[1],score:[0,1]},
      options:["All runners advance one base \u2014 the balk gives them a free base","The pitch is just called a ball and the count changes","The runner on first is sent back and the pitcher gets a warning","The play is dead and everything resets \u2014 do-over for the pitcher"],
      best:0,explanations:["Correct! A balk means all runners advance one base for free. A balk is an illegal motion by the pitcher designed to trick the runners. The most common balks are: starting your windup and stopping, faking a throw to first without stepping off the rubber, or making a pitching motion without throwing. The rule prevents pitchers from deceiving runners.","A balk is not just a ball added to the count. It's a much bigger penalty \u2014 all runners move up one base. If a runner is on third, a balk scores a run! Pitchers have to be very careful with their motions.","There are no warnings for balks in baseball. Once the umpire sees an illegal motion, the balk is called immediately and runners advance. Pitchers learn proper mechanics to avoid balks.","The play doesn't reset. The balk has a real consequence \u2014 runners advance. You can't just call a do-over when a pitcher makes an illegal move. The penalty is there to keep the game fair for baserunners."],
      rates:[85,30,15,10],concept:"A balk is an illegal motion by the pitcher. When called, all runners advance one base for free. Pitchers must follow the rules of their windup!",anim:"advance"},
    {id:"rl14",title:"Tag Up on Foul Fly",diff:1,cat:"rules",conceptTag:"tag-up",
      description:"Runners on first and third with one out. The batter hits a towering pop-up that drifts into foul territory near the third base dugout. The third baseman makes the catch. The runner on third touches the base and sprints home. The runner on first stays put. Is this play legal?",
      situation:{inning:"Bot 5",outs:1,count:"1-1",runners:[1,3],score:[1,2]},
      options:["Yes \u2014 you can tag up on any caught fly ball, including foul balls","No \u2014 you cannot tag up on a ball caught in foul territory","Only the runner on third can tag up, not the runner on first","It's the umpire's judgment call whether the catch was close enough to fair"],
      best:0,explanations:["Correct! Any caught fly ball \u2014 fair or foul \u2014 allows runners to tag up and advance. The runner on third tagging and scoring on a caught foul pop-up is a perfectly legal and smart play. If the catch is deep enough, it works just like a sacrifice fly. Both runners could tag up if they wanted to.","This is a common misunderstanding! Foul balls that are caught are treated exactly like fair ball catches for tag-up purposes. Runners can absolutely tag and advance once the catch is made.","Both runners can tag up on any caught fly ball. The runner on first could try to advance to second if they wanted, though it would be risky on a short pop-up. Any runner can tag up on any catch.","The fair/foul distinction doesn't matter for tagging up. A catch in foul territory works the same as a catch in fair territory. There's no judgment call needed \u2014 the rule is clear."],
      rates:[90,20,25,10],concept:"You can tag up on ANY caught fly ball \u2014 fair or foul! Smart baserunners are always ready to advance after a catch.",anim:"score"},
    {id:"rl15",title:"The Appeal Play",diff:3,cat:"rules",
      description:"Runner on second, one out. A deep fly ball is hit to center field and caught. The runner on second tags up and advances to third. But the center fielder notices the runner may have left second base a split second before the catch. The defense wants to challenge. How do they appeal?",
      situation:{inning:"Top 7",outs:1,count:"-",runners:[3],score:[1,3]},
      options:["Throw the ball to second base and the fielder steps on the bag while the defense asks the umpire to make the call","Yell at the umpire that the runner left early","Push a button to trigger instant replay","The pitcher just has to point at the runner and the umpire checks"],
      best:0,explanations:["Correct! An appeal play requires the defense to physically throw the ball to the base in question and have a fielder touch the bag while appealing to the umpire. The umpire then rules whether the runner left early. If the runner did leave early, they're out. It's the defense's responsibility to make the appeal \u2014 umpires won't call it on their own.","Just yelling at the umpire doesn't count as a proper appeal. The defense must make a physical play \u2014 throw the ball to the base and have a fielder touch it while asking for the call. Umpires require a formal appeal.","Instant replay isn't used for tag-up appeals in this way. The defense must make a traditional appeal play on the field. In some leagues, replay can be used afterward, but the appeal must happen first.","There's no pointing rule in baseball. The defense has to actually throw the ball to the base and ask the umpire to make the call. It requires a real baseball play, not just a gesture."],
      rates:[85,15,20,10],concept:"An appeal play means the defense throws to the base and asks the umpire to rule. Umpires don't call tag-up violations unless the defense appeals!",anim:"catch"},
    {id:"rl16",title:"Running the Baseline",diff:2,cat:"rules",
      description:"Runner on first tries to steal second. The catcher throws to the shortstop covering the bag. The runner sees the throw coming and veers way off to the right \u2014 almost into the outfield grass \u2014 to try to dodge the tag. The shortstop chases and tags him. The runner says he was safe because he wasn't tagged on the base. Is the runner out?",
      situation:{inning:"Top 6",outs:0,count:"-",runners:[1],score:[2,2]},
      options:["Yes \u2014 the runner is out for running more than 3 feet outside the baseline to avoid a tag","No \u2014 runners can run anywhere they want on the field","Only if the umpire thinks the runner went too far \u2014 it's a judgment call with no set distance","The runner is safe because the shortstop left the base to chase him"],
      best:0,explanations:["Correct! A runner is out if they run more than three feet away from the baseline to avoid being tagged. The baseline is defined as a direct line between the runner and the base they're heading toward. Runners can't just run anywhere on the field to dodge tags \u2014 that would make the game chaos!","Runners definitely cannot run anywhere they want. There's a three-foot rule: if you deviate more than three feet from the baseline to avoid a tag, you're out. This keeps the game fair for both offense and defense.","There IS a set distance \u2014 three feet. The umpire judges whether the runner went beyond three feet from the baseline, but the rule is specific about the distance. It's not purely subjective.","The shortstop is allowed to chase a runner. That's part of playing defense. The issue is that the runner went too far off the baseline to avoid the tag, which is against the rules."],
      rates:[85,10,30,20],concept:"Runners must stay within three feet of the baseline when a fielder is trying to tag them. Going outside that line means you're out!",anim:"steal"},
    {id:"rl17",title:"Ground Rule Double",diff:1,cat:"rules",
      description:"The batter hits a hard line drive that bounces in fair territory in right field, then hops over the outfield wall. The batter is rounding first and heading to second. The runner who was on first is already past third base heading home. What's the ruling?",
      situation:{inning:"Bot 3",outs:1,count:"0-0",runners:[1],score:[1,1]},
      options:["It's a ground rule double \u2014 batter gets second base, all runners advance two bases from where they started","The batter gets a home run since the ball went over the wall","It's a dead ball \u2014 everyone goes back to where they were","The batter gets only a single because the ball bounced first"],
      best:0,explanations:["Correct! When a fair ball bounces over the outfield wall, it's an automatic double (commonly called a ground rule double). The batter is awarded second base, and all runners advance two bases from where they were when the ball was hit. So the runner on first goes to third \u2014 NOT home, even though he was almost there. This can actually hurt the offense sometimes!","A home run requires the ball to fly over the wall without bouncing. A ball that bounces over is an automatic double, not a homer. The bounce is the key difference.","The ball is dead, but everyone doesn't go back. The rule awards the batter second base and advances all runners two bases. The play has a result \u2014 it's just determined by the rule rather than continued play.","A ground rule double is worth two bases, not one. Even though the ball bounced, the rule awards extra bases because the ball left the field of play. The batter gets second, and runners move up two bases."],
      rates:[88,20,10,15],concept:"A ground rule double happens when a fair ball bounces over the outfield wall. The batter gets second base and all runners advance two bases.",anim:"hit"},
    {id:"rl18",title:"Two Runners, One Base",diff:2,cat:"rules",
      description:"Runners on first and second, no outs. The batter hits a fly ball to right field. The runner on second tags up and advances to third. But the runner on first panics, thinks it's going to drop, and also runs to third base. Now both runners are standing on third base at the same time. Who gets the base?",
      situation:{inning:"Top 4",outs:0,count:"1-0",runners:[1,2],score:[0,0]},
      options:["The lead runner (who was on second) owns the base \u2014 the trailing runner can be tagged out","The first runner to touch the base gets it \u2014 first come, first served","Both runners are safe as long as they're touching the base","Both runners are out for causing confusion on the basepaths"],
      best:0,explanations:["Correct! When two runners end up on the same base, the lead runner (the one who was originally ahead on the basepaths) is entitled to the base. The trailing runner is considered 'off base' and can be tagged out. In this case, the runner who was on second base owns third, and the runner from first can be tagged out.","It's not about who arrives first. Baseball gives priority to the lead runner \u2014 the one who was originally farther ahead. Even if the trailing runner got there first, the lead runner has the right to the base.","Two runners cannot both be safe on the same base. Only one runner can legally occupy a base at a time. The lead runner gets priority, and the other runner is at risk of being tagged out.","Only the trailing runner is out, not both. The lead runner didn't do anything wrong \u2014 they legally advanced to third. You can't penalize a runner for their teammate's mistake."],
      rates:[85,30,15,10],concept:"When two runners are on the same base, the lead runner (the one originally ahead) gets the base. The other runner can be tagged out!",anim:"catch"},
    {id:"rl19",title:"Is He Out? The Third Strike Rule",diff:2,cat:"rules",
      description:"Bottom of the 8th, tie game. The pitcher throws a nasty splitter that hits the dirt — strike three! But the catcher bobbles it and the ball rolls to the backstop. Runner on third, 2 outs. The home crowd cheers thinking the inning is over. Is the batter out?",
      situation:{inning:"Bot 8",outs:2,count:"3-2",runners:[3],score:[4,4]},
      options:["The batter is out — strike three ended the inning regardless","The batter can run to first — first base is empty and there are 2 outs","The runner on third automatically scores — the ball was a wild pitch","The umpire must signal before any runners can move"],
      best:1,explanations:["Not so fast! When the catcher doesn't cleanly catch strike three AND first base is unoccupied with 2 outs, the batter becomes a runner. The inning is NOT over until someone tags the batter or throws him out at first.","Correct! This is the dropped third strike rule in action. With 2 outs and first base empty, the batter can run to first. The catcher must recover the ball and throw to first (or tag the batter) before he's safe. Meanwhile, the runner on third might score on the chaos!","The runner on third doesn't automatically score — he can only advance at his own risk. If the catcher recovers the ball quickly, the runner might stay at third. The wild pitch just means the play is live.","No umpire signal is needed — the play is live immediately! Once the catcher fails to catch strike three, runners can advance at their own risk. The batter-runner needs to recognize the situation and run."],
      rates:[25,88,15,20],concept:"With 2 outs and first base empty, a dropped/uncaught third strike lets the batter run to first — the play is live and the catcher must throw him out.",anim:"safe",conceptTag:"dropped-third-strike"},
  ],
  counts: [
    ...
    {id:"cn7",title:"First Pitch After a Walk (Pitcher)",diff:1,cat:"counts",conceptTag:"first-pitch-strike",
    ...
    {id:"cn9",title:"3-0 Hitter's Count",diff:1,cat:"counts",
      description:"You're batting with a 3-0 count. The pitcher has missed badly with three straight pitches and is struggling with control. The bases are empty and it's the 4th inning of a close game. What's the smartest approach for this at bat?",
      situation:{inning:"Bot 4",outs:1,count:"3-0",runners:[],score:[2,3]},
      options:["Take the pitch \u2014 a 3-0 count is the best time to wait for ball four and a free walk","Swing at a fastball right down the middle if you get one, but take anything else","Swing at the first pitch you can reach \u2014 this pitcher can't throw strikes","Bunt for a base hit while the defense isn't expecting it"],
      best:0,explanations:["At 3-0, the pitcher is in deep trouble. Taking the pitch is usually the smartest play because you're one ball away from a free walk. Even if the pitcher throws a strike, you're still ahead 3-1 with the advantage. Let the struggling pitcher dig their own hole \u2014 patience wins in a 3-0 count.","Swinging 3-0 is sometimes okay for elite hitters who get the green light from their coach, but for most players, the best strategy is to take the pitch. The odds of a walk are very high, and there's no reason to help a struggling pitcher by swinging.","Swinging at anything you can reach on 3-0 is reckless. The whole point of a 3-0 count is that the pitcher can't find the zone. Let them keep missing! Swinging at a marginal pitch lets the pitcher off the hook.","Bunting on 3-0 makes zero sense. You're about to get a free base via a walk. Why would you bunt and risk making an out when the pitcher can't throw strikes? Be patient and take your free base."],
      rates:[88,40,15,10],concept:"A 3-0 count is called a 'hitter's count' because the pitcher is in trouble. The smartest play is usually to take the pitch and get closer to a walk.",anim:"walk"},
    {id:"cn10",title:"Behind 0-1",diff:2,cat:"counts",
      description:"The pitcher threw a first-pitch strike and now you're behind 0-1. The pitcher has a good fastball and a sharp breaking ball. You're a contact hitter who doesn't strike out much. How do you adjust your approach now that you're behind in the count?",
      situation:{inning:"Top 5",outs:0,count:"0-1",runners:[1],score:[1,1]},
      options:["Shorten your swing and look to make contact \u2014 protect the zone","Keep swinging the same way \u2014 one strike doesn't change anything","Guess breaking ball and sit on it exclusively","Look for a pitch you can pull for extra bases to make up for falling behind"],
      best:0,explanations:["Smart adjustment! At 0-1, the pitcher has the slight advantage and might throw something tricky. Shortening your swing and focusing on making contact keeps you in the at bat. You don't need to do anything special \u2014 just put the bat on the ball and avoid falling further behind to 0-2.","Actually, one strike changes a lot. At 0-1, the pitcher can afford to throw a waste pitch or expand the zone. You need to adjust by being more selective on pitches outside the zone while still protecting against strikes. Approach should always adapt to the count.","Guessing one pitch exclusively at 0-1 is risky. If you guess wrong, you could fall to 0-2 and be in real trouble. At 0-1, stay balanced and ready for any pitch in the zone. Guessing games are for deeper counts.","Trying to pull everything for power when behind in the count leads to weak grounders and strikeouts. Contact hitters succeed by using the whole field. Stay within your game \u2014 don't try to be a power hitter because of one strike."],
      rates:[82,25,20,15],concept:"When you fall behind 0-1, shorten your swing and focus on contact. Protect the zone and stay alive in the at bat.",anim:"hit"},
    {id:"cn11",title:"1-2 Two Outs Rally",diff:3,cat:"counts",
      description:"Two outs, runners on second and third. Your team is down by one run in the 7th inning. The count is 1-2 \u2014 the pitcher is one strike away from ending the inning. He's been mixing fastballs and sliders all game. You need to keep this rally alive.",
      situation:{inning:"Bot 7",outs:2,count:"1-2",runners:[2,3],score:[3,4]},
      options:["Choke up on the bat, shorten your swing, and fight off anything close \u2014 foul off tough pitches until you get something to hit","Sit on fastball and take a big cut \u2014 go for the game-tying hit","Take the next pitch hoping it's a ball to even the count at 2-2","Swing at anything near the zone \u2014 you can't afford to take strike three looking"],
      best:0,explanations:["This is elite hitting mentality! At 1-2 with the game on the line, the priority is survival. Choke up, shorten your swing, and battle. Foul off tough pitches to stay alive. Great hitters turn 1-2 counts into 3-2 counts all the time by fighting off pitches. Eventually the pitcher might make a mistake you can drive.","Taking a big hack at 1-2 with two outs is how you end up walking back to the dugout. The pitcher has the advantage and might throw something nasty. A big swing has more holes in it. Shorten up and battle.","Taking a pitch at 1-2 is extremely risky. If it catches the corner, you're out looking \u2014 and taking a called third strike with runners on feels terrible. Be ready to swing at anything close and protect the plate.","While you need to protect the zone, swinging at 'anything near the zone' leads to chasing bad pitches. There's a difference between protecting the plate with a short swing and flailing at everything. Stay disciplined but aggressive."],
      rates:[88,20,15,30],concept:"In a 1-2 count with the game on the line, choke up and battle. Foul off tough pitches and wait for your opportunity \u2014 never give in to the pitcher.",anim:"hit"},
    {id:"cn12",title:"First Pitch Fastball",diff:1,cat:"counts",
      description:"You step into the batter's box for your first at bat. This pitcher throws a first-pitch fastball to almost every batter \u2014 you noticed while watching from the dugout. The pitcher winds up and here comes the first pitch. It's a fastball right down the middle!",
      situation:{inning:"Bot 1",outs:0,count:"0-0",runners:[],score:[0,0]},
      options:["Swing! If you know a first-pitch fastball is coming, be ready to attack it","Take it for a strike to see the pitcher's speed and get comfortable","Bunt it \u2014 surprise the defense on the very first pitch","Foul it off on purpose to see more pitches"],
      ...
      rates:[85,30,15,10],concept:"Do your homework! Watch the pitcher from the dugout. If you know a first-pitch fastball is coming, be aggressive and ready to attack.",anim:"hit"},
    {id:"cn13",title:"2-0 Sitting Fastball",diff:2,cat:"counts",
      ...
      rates:[85,35,25,15],concept:"A 2-0 count is a great opportunity. Look for a fastball in YOUR zone \u2014 if you get it, swing hard. If not, you're still ahead in the count.",anim:"hit"},
    {id:"cn14",title:"Full Count Two Outs",diff:2,cat:"counts",
      ...
      options:["Protect the plate \u2014 fight off anything close and don't go down looking","Sit on one specific pitch and take a huge swing at it","Take the pitch hoping for ball four","Close your eyes and swing as hard as you can"],
      best:0,explanations:["On a 3-2 count with two outs, the worst thing you can do is take a called strike three. Expand your zone slightly, shorten your swing, and fight off borderline pitches. The runners are moving, so even a single could score both runs. Just put the ball in play and let good things happen.","Sitting on one specific pitch in a 3-2 two-out count is too risky. If you guess wrong, the pitch might catch the corner and you're out looking. You need to be ready for anything in the zone and protect the plate.","Taking a 3-2 pitch hoping for ball four is extremely risky with two outs. If it catches the corner, you struck out looking with runners on and your team needed you. You can't leave the bat on your shoulder here \u2014 protect the plate!","Closing your eyes and swinging is not a strategy \u2014 it's giving up. Keep your eyes on the ball, look for something in the zone, shorten your swing, and compete. Seeing the ball is literally the most important part of hitting."],
      rates:[85,25,15,10],concept:"On a full count with two outs, protect the plate! Shorten your swing and don't go down looking. Put the ball in play and make the defense work.",anim:"hit"},
    {id:"cn15",title:"0-2 Waste Pitch",diff:2,cat:"counts",
      description:"You're pitching with an 0-2 count on the batter. You've got him in a deep hole with two quick strikes. Your catcher puts down the sign. What's the best strategy when you're ahead 0-2?",
      situation:{inning:"Top 3",outs:1,count:"0-2",runners:[],score:[3,1]},
      options:["Throw a pitch just outside the zone \u2014 tempt the batter to chase a bad pitch","Throw your best fastball right down the middle to put him away","Throw at his feet to intimidate him, then come back with a strike","Throw the same pitch that got strike two \u2014 it worked once, it'll work again"],
      ...
      rates:[85,15,10,30],concept:"At 0-2, use a 'waste pitch' just off the plate. You can afford a ball, and if the batter chases, you get an easy out. Expand the zone!",anim:"strike"},
    {id:"cn16",title:"3-1 Green Light",diff:2,cat:"counts",conceptTag:"count-leverage",
      ...
      rates:[85,30,20,10],concept:"A 3-1 green light means look for YOUR pitch and attack it. The pitcher needs a strike, so the fastball is coming \u2014 be ready!",anim:"hit"},
    {id:"cn17",title:"1-1 Neutral Count",diff:1,cat:"counts",
      ...
      options:["Look fastball but be ready to adjust \u2014 stay balanced and aggressive on hittable pitches","Sit on an off-speed pitch since the pitcher got a strike and might try to trick you now","Take the next pitch no matter what to get ahead 2-1","Guess what's coming and commit to one specific pitch location"],
      best:0,explanations:["At 1-1, the best approach is to look fastball and react to off-speed. Since you're even in the count, you want to be ready for the most common pitch (fastball) while staying flexible. If you get a hittable pitch, attack it. If it's a ball, you go to 2-1 and have the advantage.","Sitting on an off-speed pitch at 1-1 is risky because pitchers throw fastballs more often than anything else. If a fastball comes and you're looking breaking ball, you'll be late and miss a hittable pitch. Look hard (fastball) and adjust soft (off-speed).","Taking a pitch at 1-1 just to get to 2-1 means you might watch a meatball go by. If the pitcher throws a fastball right down the middle, you want to be swinging! Don't give away strikes \u2014 be ready to hit.","At 1-1, guessing one exact pitch and location is a coin flip. The pitcher has too many options for you to narrow it down to one spot. Stay balanced, look fastball, and let your hands react to what you see."],
      rates:[85,25,20,15],concept:"At 1-1, stay balanced: look fastball and adjust to off-speed. Be ready to swing at hittable pitches but don't chase out of the zone.",anim:"hit"},
    {id:"cn18",title:"3-2 Protect the Plate",diff:3,cat:"counts",
      description:"Full count, 3-2, with two outs in the bottom of the 9th. Your team is down by one with runners on first and third. The pitcher has been throwing a devastating slider all game that dives off the plate at the last second. You've already fouled off three tough pitches. The pitcher winds up for the payoff pitch.",
      situation:{inning:"Bot 9",outs:2,count:"3-2",runners:[1,3],score:[4,5]},
      options:["Widen your zone slightly \u2014 anything close to the plate, fight it off. Don't get caught looking.","Sit on the slider since that's his best pitch and he'll want to finish you with it","Take the pitch \u2014 if it's the slider it will probably be a ball and you walk","Swing as hard as possible \u2014 if you connect, you win the game"],
      best:0,explanations:["This is championship-level plate discipline! In a 3-2 count with two outs and the game on the line, you CANNOT take a called strike three. Widen your zone slightly and fight off anything close. Foul off tough pitches, put hittable ones in play, and refuse to go down without swinging. The runners are moving \u2014 even a broken-bat single could win it.","Sitting on the slider is too narrow. What if he comes with a fastball on the corner? You'll watch strike three go by. At 3-2 with the game on the line, you have to be ready for everything, not just one pitch.","Taking a 3-2 pitch in this situation could win you a walk \u2014 or end the game on a called strike three. With your team's season on the line, you absolutely cannot leave the bat on your shoulder. If it's close, you have to swing.","Maximum effort swings have maximum holes. A big, wild swing is more likely to miss than a controlled, shortened swing. In this spot, contact is king. Shorten up, stay inside the ball, and put it in play. Heroes make contact."],
      rates:[88,25,15,20],concept:"In a 3-2 count with the game on the line, widen your zone and battle. Don't let the umpire end your season \u2014 fight off every borderline pitch.",anim:"hit"}
  ],
};
...
function enrichFeedback(scenario, choiceIdx, situation) {
  ...
  if (re24 > 0.5 && runners.length > 0)
    insights.push({icon:"📊", text:`With ${runners.length === 3 ? "bases loaded" : runners.length === 2 ? "2 runners on" : "a runner on"}, your team expects ${re24.toFixed(2)} runs from here.`});
  const ci = getCountIntel(count);
  if (ci)
    insights.push({icon:"🔢", text:`At ${count} (${ci.label}), hitters bat .${Math.round(ci.ba*1000)}.`});
  const pressure = getPressure(situation);
  if (pressure >= 50)
    insights.push({icon:"🔥", text:`Pressure: ${pressure}/100 — ${pressure>=80?"Clutch time!":pressure>=60?"High stakes!":"Heating up!"}`});
  ...
  if (scenario?.concept && /bunt/i.test(scenario.concept)) {
    ...
    if (bunt.delta !== null) insights.push({icon:"📉", text:bunt.explanation});
  }
  ...
  if (scenario?.concept && /steal/i.test(scenario.concept)) {
    ...
    insights.push({icon:"🏃", text:`Need ${steal.breakeven}% success rate to break even on a steal here.`});
  }
  ...
  if (runners.length > 0 && outs !== undefined) {
    ...
    if (prob !== undefined)
      insights.push({icon:"🏃", text:`Runner on ${baseKey} with ${outs} out${outs !== 1 ? 's' : ''}: ${Math.round(prob * 100)}% chance of scoring this inning.`});
  }
  // Two-strike K rate
  if (['0-2','1-2'].includes(count)) {
    const kRate = BRAIN.stats.countRates[count]?.k;
    if (kRate) insights.push({icon:"⚠️", text:`${count} count: pitcher has a ${Math.round(kRate * 100)}% strikeout rate on this pitch. Protect the zone!`});
  }
  ...
  if (scenario?.concept && /pitch.*(seq|type|select|choice|tunnel)/i.test(scenario.concept))
    insights.push({icon:"📊", text:"Best put-away pitches by run value: Sweeper (-1.6) → Slider (-1.4) → Changeup (-1.2). Fastball alone (+0.2) needs offspeed to be dangerous."});
  ...
  if (situation.inning && situation.score) {
    ...
    if (wpCtx.isLateClose)
      insights.push({icon:"📈", text:`Win probability: ${wpCtx.wpPct}% with Leverage Index ${wpCtx.li}x. ${wpCtx.recommendation}`});
...
1. SITUATION VALIDITY (check ALL): outs is 0, 1, or 2 (never 3). Count format is "B-S" where B=0-3, S=0-2 (INVALID: "3-3", "4-1", "2-3"). Runners array contains only [1,2,3] with no duplicates. Score is [home, away] both non-negative integers. If "Bot 9" and home team ahead, the game would be over — don't use this. Inning 10+: ghost runner starts on 2nd (runners MUST include 2 at 0 outs).
1b. EXTRA INNINGS: If inning is 10+, runner automatically starts on 2nd base (MLB rule since 2020). Bunting ghost runner from 2nd→3rd costs only 0.19 RE — do NOT mark bunt as clearly wrong in extra innings. Prefer innings 1-9 unless teaching extra-inning concepts.
2. Can this player physically perform all 4 options from their position in this moment?
2a. OPTION TIMING: All 4 options must describe decisions at the SAME decision point. Do not mix pre-pitch decisions (pitch selection) with mid-play decisions (where to throw after contact). The description must establish WHEN the decision is being made.
...
4b. FOUL TIP vs FOUL BALL: Foul TIP (into glove) = strike, CAN be strike 3, runners CAN tag up. Foul BALL with 2 strikes = count stays EXCEPT bunted foul with 2 strikes = out. If scenario involves a two-strike foul, specify which type.
...
9b. DROPPED THIRD STRIKE: If scenario involves a strikeout, specify whether ball was caught cleanly or hit the dirt. "Hold the ball" is only correct if catch was clean.
9c. MANAGER SCOPE: No option should describe a specific pitch type or catcher sequence. Wrong: "Signal for a curveball." Correct: "Make the pitching change."
9d. BASERUNNER SCOPE: All options must be actions the runner physically performs. No directing teammates or calling plays — that's the coach's job.
            ...
            <div style={{background:"#1e293b",borderRadius:20,padding:"32px 24px",maxWidth:360,width:"100%",textAlign:"center",border:"2px solid rgba(34,197,94,.3)"}}>
              ...
              {(()=>{const ps=stats.ps[masteryPos]||{p:0,c:0};const pAcc=ps.p>0?Math.round((ps.c/ps.p)*100):0;return(
                <div style={{display:"flex",justifyContent:"center",gap:16,marginBottom:16}}>
                  <div><div style={{fontSize:20,fontWeight:800,color:"#22c55e"}}>{pAcc}%</div><div style={{fontSize:9,color:"#6b7280"}}>Accuracy</div></div>
                  <div><div style={{fontSize:20,fontWeight:800,color:"#3b82f6"}}>{ps.p}</div><div style={{fontSize:9,color:"#6b7280"}}>Played</div></div>
                  <div><div style={{fontSize:20,fontWeight:800,color:"#f59e0b"}}>{ps.c}</div><div style={{fontSize:9,color:"#6b7280"}}>Correct</div></div>
                </div>
              )})()}
          ...
          {(()=>{const p=getPressure(sc.situation);if(p<=20)return null;const pl=getPressureLabel(p);
            return(<div style={{marginBottom:8,padding:"5px 10px",background:"rgba(0,0,0,.15)",borderRadius:8,border:"1px solid rgba(255,255,255,.04)"}}>
              <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:3}}>
                ...
                <span style={{fontSize:9,color:"#6b7280",fontWeight:600}}>{p}/100</span>
              </div>
